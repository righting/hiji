...
<div id="f_rz" class="wrapper">
    <ul>
        <li><a href=""><img src="<?php echo jf_TEMPLATES_URL;?>/images/f_rz-4_01.jpg" /></a></li>
        <li><a href=""><img src="<?php echo jf_TEMPLATES_URL;?>/images/f_rz-4_02.jpg" /></a></li>
        <li><a href=""><img src="<?php echo jf_TEMPLATES_URL;?>/images/f_rz-4_03.jpg" /></a></li>
        <li><a href=""><img src="<?php echo jf_TEMPLATES_URL;?>/images/f_rz-4_04.jpg" /></a></li>
        <li><a href=""><img src="<?php echo jf_TEMPLATES_URL;?>/images/f_rz-4_05.jpg" /></a></li>
        <li><a href=""><img src="<?php echo jf_TEMPLATES_URL;?>/images/f_rz-4_06.jpg" /></a></li>
    </ul>
</div>
...
<script type="text/javascript" src="<?php echo jf_TEMPLATES_URL;?>/js/scroll.js" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo jf_TEMPLATES_URL;?>/js/home_spyb.js" charset="utf-8"></script>
