...
<head>
    ...
    <title>海吉壹佰<?php echo $output['webTitle']?></title>
    ...
    <!--[if IE 6]>
    <link rel="shortcut icon" href="<?php echo HJB_TEMPLATES_URL;?>/favicon.ico" type="image/x-icon">
    <![endif]-->
    <style type="text/css">
        body {
            _behavior: url(<?php echo HJB_TEMPLATES_URL;?>/css/csshover.htc);
        }
    </style>
    <link href="<?php echo HJB_TEMPLATES_URL;?>/css/base.css" rel="stylesheet" type="text/css">
    <link href="<?php echo HJB_TEMPLATES_URL;?>/css/header.css" rel="stylesheet" type="text/css">
    <link href="<?php echo HJB_TEMPLATES_URL;?>/css/font-awesome.min.css" rel="stylesheet" />
    <link href="<?php echo HJB_TEMPLATES_URL;?>/css/index.css" rel="stylesheet" type="text/css">
    <link href="<?php echo HJB_TEMPLATES_URL;?>/css/new_header.css" rel="stylesheet" type="text/css">
    <!--[if IE 7]>
    <link rel="stylesheet" href="<?php echo HJB_TEMPLATES_URL;?>/css/font-awesome-ie7.min.css">
    <![endif]-->
    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
    <script src="<?php echo HJB_TEMPLATES_URL;?>/js/html5shiv.js"></script>
    <script src="<?php echo HJB_TEMPLATES_URL;?>/js/respond.min.js"></script>
    <![endif]-->
    <!--[if IE 6]>
    <script src="<?php echo HJB_TEMPLATES_URL;?>/js/IE6_PNG.js"></script>
    <script>
...
<![endif]-->
    <script src="<?php echo HJB_TEMPLATES_URL;?>/js/jquery.js"></script>
    <script src="<?php echo HJB_TEMPLATES_URL;?>/js/common.js" charset="utf-8"></script>
...
<div class="public-top-layout w" style="background-color: #FAFAFA;">
    ...
    <header class="public-head-layout wrapper">
        <h1 class="site-logo">
            <a href="/" target="_blank">
                <img src="<?php echo HJB_TEMPLATES_URL;?>/images/H_logo.jpg" class="pngFix" style="margin-right:7px;">
            </a>
            <a href="/hjb/" target="_blank">
                        ...
                        <div class="browse-history">
                            <div class="part-title">
                                ...
                                <ul>
                                    ...
                                    <?php }?>
                                    <!--<li class="no-goods"><img class="loading" src="<?php /*echo HJB_TEMPLATES_URL;*/?>/images/loading.gif" /></li>-->
                                </ul>
                        </div>
                    <?php }?>
                </dd>
...
<nav class="public-nav-layout">
    <div class="wrapper">
        <!--<div class="all-category">
            <div class="title">
                <h3 style="line-height:22px; color:#FFF; font-size:14px; font-weight:bold; text-align:center;">海吉币兑换中心</h3>
            </div>
        </div>-->
        <ul class="site-menu">
            <span class="hot"></span>
