...
(function($) {
    $.show_nc_login = function(options) {
        ...
        login_dialog_html.append('<form class="bg" method="post" id="ajax_login" action="'+settings.action+'"></form>').find('form')
        	...
        	.append('<ul><li>›&nbsp;如果您没有登录账号，请先<a class="register" href="/member/index.php?controller=login&amp;op=register">注册会员</a>然后登录</li><li>›&nbsp;如果您<a class="forget" href="/member/index.php?controller=login&amp;op=forget_password">忘记密码</a>？，申请找回密码</li></ul>')
