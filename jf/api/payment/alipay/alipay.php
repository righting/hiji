...
class alipay
{
    ...
    public function get_payurl()
    {
        $this->parameter         = [
            ...
            'notify_url'         => 'http://' . $_SERVER['HTTP_HOST'] . "/jf/api/payment/alipay/notify_url.php",    //通知URL
            'sign_type'          => 'MD5',                //签名方式
            'return_url'         => 'http://' . $_SERVER['HTTP_HOST'] . "/shop/index.php?controller=member_point_order&action=index",    //返回URL
            'extra_common_param' => 1,
            'subject'            => $this->order['goods_name'],    //商品名称
            'body'               => $this->order['orderNo'],    //商品描述
            'out_trade_no'       => $this->order['orderNo'],        //外部交易编号
            'payment_type'       => 1,                            //支付类型
            ...
            'price'              => $this->order['order_money'],//订单总价
            'quantity'           => 1,//商品数量
            'total_fee'          => 0,//物流配送费用
