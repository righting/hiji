                ...
                <div class="middle">
                            ...
                            <form id="login_form" method="post" action="<?php echo urlLogin('login', 'login'); ?>"
                                ...
                                <div class="bottom">
                                    ...
                                    <?php if (C('qq_isuse') == 1 || C('sina_isuse') == 1 || C('weixin_isuse') == 1) { ?>
                                        ...
                                        <a href="<?php echo DISTRIBUTE_SITE_URL; ?>/api.php?controller=tosina" title="新浪微博账号登录"
                                           class="mr20">新浪微博</a><?php } ?>
                                        <?php if (C('qq_isuse') == 1) { ?><a
                                            href="<?php echo DISTRIBUTE_SITE_URL; ?>/api.php?controller=toqq" title="QQ账号登录"
                    ...
                    <?php if (C('node_chat')) { ?>
                        <div class="chat"><a href="javascript:void(0);" id="chat_show_user"><span class="icon"></span><i
                                        id="new_msg" class="new_msg" style="display:none;"></i><span
                                        class="tit">在线联系</span></a></div>
                    <?php } ?>
                </div>
        ...
        <div class="user-entry">
            ...
            <?php } else { ?>
                ...
                alt="<?php echo $lang['homepage']; ?>"><?php echo $output['setting_config']['site_name']; ?></a><?php if (C('qq_isuse') == 1 || C('sina_isuse') == 1 || C('weixin_isuse') == 1) { ?>
                    <span class="other">
      <?php if (C('qq_isuse') == 1) { ?>
          <a href="<?php echo DISTRIBUTE_SITE_URL; ?>/api.php?controller=toqq" title="QQ账号登录" class="qq"><i></i></a>
      <?php } ?>
                        <?php if (C('sina_isuse') == 1) { ?>
                            <a href="<?php echo DISTRIBUTE_SITE_URL; ?>/api.php?controller=tosina"
                ...
                <?php } ?> <span>[<a
                            href="<?php echo urlLogin('login'); ?>"><?php echo $lang['nc_login']; ?></a>]</span> <span>[<a
