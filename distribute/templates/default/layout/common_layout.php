...
<style type="text/css">
body {
_behavior: url(<?php echo DISTRIBUTE_TEMPLATES_URL;
?>/css/csshover.htc);
}
</style>
...
<![endif]-->
<script>
var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo SHOP_SITE_URL;?>';var SHOP_SITE_URL = '<?php echo SHOP_SITE_URL;?>';var DISTRIBUTE_SITE_URL = '<?php echo DISTRIBUTE_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var SHOP_TEMPLATES_URL = '<?php echo DISTRIBUTE_TEMPLATES_URL;?>';
</script>
...
.search-form .select_option{border:2px solid #bf35f8;border-top:none;display:none;left:-2px;top:36px;position:absolute;z-index:99;background:#fff;}
...
<div class="header-wrap">
  <header class="public-head-layout wrapper">
    <h1 class="site-logo"><a href="<?php echo SHOP_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['site_logo']; ?>" class="pngFix">
    ...
    <div class="logo-test"><?php echo $output['setting_config']['ccynet_stitle']; ?></div>
...
<i></i>
    ...
    <div class="mod_minicart" style="">
		<a id="nofollow" target="_self" href="<?php echo SHOP_SITE_URL;?>/index.php?controller=cart" class="mini_cart_btn">
                        <i class="cart_icon"></i>
		...
		<div id="minicart_list" class="minicart_list">
			...
			<div class="list_detail">
				<!--购物车有商品时begin-->
				<ul><img class="loading" src="<?php echo DISTRIBUTE_TEMPLATES_URL;?>/images/loading.gif" /></ul>
				<div class="checkout_box">
                    <p class="fl">共<em class="tNum"><?php echo $output['cart_goods_num'];?></em>件商品,合计：<em class="tSum">0</em></p>
					<a rel="nofollow" class="checkout_btn" href="<?php echo SHOP_SITE_URL;?>/index.php?controller=cart" target="_self"> 去结算 </a>
				</div>
...
<!--    <div class="head-user-menu">
      <dl class="my-cart">
        ...
        <dd>
          ...
          <div class="checkout"> <span class="total-price">共<i><?php echo $output['cart_goods_num'];?></i><?php echo $lang['nc_kindof_goods'];?></span><a href="<?php echo SHOP_SITE_URL;?>/index.php?controller=cart" class="btn-cart">结算购物车中的商品</a> </div>
        </dd>
      </dl>
    </div>-->
  </header>
        ...
        <ul class="site-menu">
            ...
            <?php if(!empty($output['nav_list']) && is_array($output['nav_list'])) {?>
                <?php foreach($output['nav_list'] as $nav_first){?>
                    <?php if($nav_first['nav_location'] == 1 ){?>
                        <?php if(!empty($nav_first['_child'] )){?>
                            <li class="links_a"><a <?php if(($output['index_sign'] == $nav_first['nav_id'] || $output['index_sign'] == $nav_first['nav_pid']) && $output['index_sign'] != '0') {echo 'class="current"';} ?>><span>&nbsp;</span><?php echo $nav_first['nav_title'];?><i></i></a>
                        ...
                        <?php }else{?>
                            <li><a href="<?php echo $nav_first['nav_url'];?>" <?php if(($output['index_sign'] == $nav_first['nav_id'] || $output['index_sign'] == $nav_first['nav_pid']) && $output['index_sign'] != '0') {echo 'class="current"';} ?>> <span><?php echo $nav_first['nav_title'];?></span></a></li>
                        <?php }?>
                    <?php }?>
                <?php }?>
            <?php }?>
