        ...
        if ($param['trace_title']){
            ...
            if (!empty($matches[1])){
                ...
                foreach ($member_list as $k=>$v){
                    $param['trace_title'] = preg_replace("/@(".$v['member_name'].")([\s|:|：]|$)/is",'<a href=\"%siteurl%index.php?controller=member_snshome&mid='.$v['member_id'].'\" target="_blank">@${1}</a>${2}',$param['trace_title']);
                }
            }
            unset($matches);
        }
