...
class page_classModel extends Model {
    public function __construct(){
        parent::__construct('page_class');
    }
    /**
     * 类别列表
     *
    ...
    public function add($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::insert('page_class',$tmp);
            return $result;
        }else {
            return false;
        }
    ...
    public function updates($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::update('page_class',$tmp,$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function del($id){
        if (intval($id) > 0){
            ...
            $result = Db::delete('page_class',$where);
            return $result;
        }else {
            return false;
        }
