...
class web_configModel extends Model{
    ...
    public function updateWebHtml($web_id = 1,$web_array = array()){
        ...
        if(!empty($code_list) && is_array($code_list)) {
            ...
            $setting  = Model('setting')->where(['name'=>'site_logo'])->select();
            $output['setting'] = array_column($setting,'value','name');
            ...
            switch ($web_page) {
                case 'index':
                    ...
                    break;
                case 'index_f1':
                    $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'new_index_f1.php';
                    break;
                case 'index_f2':
                    $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'new_index_f2.php';
                    break;
                case 'index_pic':
                ...
                case 'channel_fl':
                    ...
                    break;
                case 'index_sign':
                    $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'index_sign.php';
                    break;
                case 'index_qr':
                    $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'index_qr.php';
                    break;
                case 'index_fl':
                    $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'index_fl.php';
                    break;
                case 'member_adv':
                    $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'member_adv.php';
                    break;
                case 'rcm_goods':
                    $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'pl_recommend.php';
                    break;
                case 'ht_index':
                    $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'ht_index.php';
                    break;
                case 'index_adv':
                    $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'index_goods_adv.php';
                    break;
                default:
                    $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'default.php';
                    break;
...
//            print_r($output);die;
    ...
    public function getGoodsList($condition = array(),$order = 'goods_id desc',$page = ''){
        ...
        $field = 'goods_id,goods_commonid,goods_name,goods_image,goods_price,goods_marketprice,goods_promotion_price,goods_salenum';
    ...
    public function updateIndexWebHtml($web_id){
        // 根据 web_id 获取所有属于该页面的数据
        ...
        $output['goods_list'] = $goods_list;

        switch($web_id){
            case 617:
                $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'new_index_20180119.php';
                break;
            case 618:
                $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'ht_index_20180119.php';
                break;
            case 621:
                $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'brand_index_20180119.php';
                break;
            case 622:
                $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'jh_index_20180119.php';
                break;
            case 623:
                $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'xp_index_20180119.php';
                break;
            case 624:
                $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'new_index_bottom_20180119.php';
                break;
            case 634:
                $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'kj_index_20180803.php';
                break;
            default:
                $style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'new_index_20180119.php';
                break;
        ...
        $update_data['web_html'] = $web_html;
       $result = $this->where(['web_id'=>$web_id])->update($update_data);
       return $result;
    }
}
