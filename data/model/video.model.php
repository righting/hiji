...
class videoModel extends Model {
    ...
    public function getVideoList($condition,$page=''){
        ...
        $param['order'] = (empty($condition['order'])?'video_sort asc,video_id desc':$condition['order']);
    ...
    private function _condition($condition){
        ...
        if ($condition['video_type'] != ''){
            $condition_str .= " and video.video_type = '". $condition['video_type'] ."'";
        }
        if ($condition['ac_id'] != ''){
