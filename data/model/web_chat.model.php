...
class web_chatModel extends Model{
    ...
    public function addMsg($msg) {
        ...
        if ($m_id > 0) {
            ...
            $goods_id = 0;
            $goods_info = array();
            $pattern = '#'.SHOP_SITE_URL.'/index.php\?controller=goods&amp;op=index&amp;goods_id=(\d+)$#';
    ...
    public function getGoodsInfo($goods_id) {
        ...
        if (is_array($goods) && !empty($goods)) {
            ...
            $goods['pic'] = cthumb($goods['goods_image'],60);
            $goods['pic24'] = cthumb($goods['goods_image'],240);
        }
        return $goods;
    }


    public function getMsgCount($condition = array()){
