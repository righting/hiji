...
class pointcartModel extends Model {
    ...
    public function getCartGoodsList($member_id){
        ...
        $pointprod_list['pgoods_shipping_fee']=$cartgoodslist_tmp['pgoods_shipping_fee'];
        $pointprod_list['pgoods_service_charge']=$cartgoodslist_tmp['pgoods_service_charge'];
    ...
    public function checkPointEnough($points, $member_id, $member_info = array()){
        ...
        $total_points = intval($member_info['member_points'])+intval($member_info['member_h_points']);
