...
class help_classModel extends Model {
    public function __construct(){
        parent::__construct('help_class');
    }
    /**
     * 类别列表
     *
    ...
    private function _condition($condition){
        ...
        if ($condition['ac_id'] != ''){
            $condition_str .= " and ac_id = '". intval($condition['ac_id']) ."'";
        }
    ...
    public function add($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::insert('help_class',$tmp);
            return $result;
        }else {
            return false;
        }
    ...
    public function updates($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::update('help_class',$tmp,$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function del($id){
        if (intval($id) > 0){
            ...
            $result = Db::delete('help_class',$where);
            return $result;
        }else {
            return false;
        }
