...
class jforderModel extends Model
{
     ...
     * @return array
     */
    public function getOoderList($condition, $field = '*', $page = 10, $order = 'id desc', $limit = '')
    {	
        $condition = $this->_getRecursiveClass($condition);
        return $this->table('integral_orders')->field($field)->where($condition)->order($order)->limit($limit)->page($page)->select();
    ...
    {   $field = 'integral_orders.*,integral_order_goods.id as order_goods_id,integral_order_goods.goodsId,integral_order_goods.goods_name,integral_order_goods.goods_image,integral_order_goods.goods_price,integral_order_goods.goods_point,integral_order_goods.goods_hjb,integral_order_goods.number';
        return $this->table('integral_orders,integral_order_goods')->field($field)->join('inner')->on('integral_orders.id = integral_order_goods.orderId')->where($condition)->find();
        //return $this->table('integral_orders')->field($field)->where($condition)->find();
    }
