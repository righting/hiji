...
//            QueueClient::push('createGoodsQRCode', array('store_id' => $store_id, 'goodsid_array' => $goodsid_array));
    ...
    {
        $return = Model('goods')->editProducesOnline(['goods_commonid' => ['in', $commonid_array], 'store_id' => $store_id]);
        if ($return) {
            // 添加操作日志
    ...
    {
        $return = Model('goods')->delGoodsNoLock(['goods_commonid' => ['in', $commonid_array], 'store_id' => $store_id]);
        if ($return) {
            // 添加操作日志
