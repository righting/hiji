...
//	        window.location.href=uri + '&' + name + '=' + items;
    ...
    $('*[nc_type="gselector"]').focus(function(){
        ...
        ajax_form(id, title, SITEURL + '/index.php?controller=store_groupbuy&action=' + op + '&dialog=1&title=' + title + '&store_id=' + store_id+ '&id=' + id + '&name=' + name + '&callback=' + callback, width);
        return false;
    });
