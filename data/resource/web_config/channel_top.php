...
<div class="channel-focus-layout style-<?php echo $output['web_id'];?>">
  <div class="channel-category">
    <ul class="menu">
      ...
      <li cat_id="<?php echo $val['gc_parent']['gc_id'];?>" class="<?php echo $i%2==1 ? 'odd':'even';?>" <?php if($i>6){?>style="display:none;"<?php }?>>
        ...
        <div class="pic"><img src="<?php echo $val['gc_parent']['gc_pic'];?>"></div>
        <?php } ?>
  ...
  <ul id="fullScreenSlides" class="full-screen-slides">
    ...
    <li style="background: <?php echo $val['color'];?> url('<?php echo $val['pic_img'];?>') no-repeat center top"> <a href="<?php echo $val['pic_url'];?>" target="_blank" title="<?php echo $val['pic_name'];?>">&nbsp;</a></li>
    <?php } ?>
    <?php } ?>
  </ul>
  <div class="jfocus-trigeminy">
    <ul>
      ...
      <li>
        ...
        <a href="<?php echo $v['pic_url'];?>" target="_blank" title="<?php echo $v['pic_name'];?>"> <img src="<?php echo $v['pic_img'];?>" alt="<?php echo $v['pic_name'];?>"></a>
        <?php } ?>
      </li>
      <?php } ?>
      <?php } ?>
