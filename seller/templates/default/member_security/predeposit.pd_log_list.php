...
<div class="essential">
    <div class="essential-nav">
        ...
        <a style="display:none" class="ncbtn ncbtn-bittersweet" title="在线充值" href="index.php?controller=predeposit&action=recharge_add"
           style="right: 207px;"><i class="icon-shield"></i>在线充值</a>
        <a class="ncbtn ncbtn-mint" href="index.php?controller=member_security&action=auth&type=pd_cash" style="right: 107px;"><i
        ...
        <?php if (count($output['list']) > 0) { ?>
            <?php foreach ($output['list'] as $v) { ?>
                <tr class="bd-line">
                    ...
                    <?php $availableFloat = (float)$v['lg_av_amount'];
                    if ($availableFloat > 0) { ?>
