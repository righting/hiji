...
<head>
    ...
    <style type="text/css">
        body { _behavior: url(<?php echo MEMBER_TEMPLATES_URL;
?>/css/csshover.htc);
        }
    </style>
    <link href="<?php echo MEMBER_TEMPLATES_URL;?>/css/new_base.css" rel="stylesheet" type="text/css">
...
<div class="header-wrap">
    <header class="public-head-layout wrapper">
        <h1 class="site-logo"><a href="<?php echo BASE_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['site_logo']; ?>" class="pngFix"></a>
            ...
            <?php if(!empty($output['nav_list']) && is_array($output['nav_list'])) {?>
                <?php foreach($output['nav_list'] as $nav_first){?>
                    <?php if($nav_first['nav_location'] == 1 ){?>
                        ...
                        <?php }else{?>
                            <li><a target="<?php echo  $nav_first['nav_new_open']==1?'_blank':'_self' ?>" href="<?php echo $nav_first['nav_url'];?>" <?php if(($output['index_sign'] == $nav_first['nav_id'] || $output['index_sign'] == $nav_first['nav_pid']) && $output['index_sign'] != '0') {echo 'class="current"';} ?>> <span><?php echo $nav_first['nav_title'];?></span></a></li>
                        <?php }?>
                    <?php }?>
                <?php }?>
            <?php }?>
