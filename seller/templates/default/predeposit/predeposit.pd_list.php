    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="ncm-table-handle"><?php if (!intval($val['pdr_payment_state'])){?>
          ...
          <p>支付</p>
          </a></span> <span><a class="btn-grapefruit" href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>', '<?php echo urlSellerMember('predeposit','recharge_del',['id'=>$val['pdr_id']]); ?>');"><i class="icon-trash"></i>
