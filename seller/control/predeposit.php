...
class predepositControl extends BaseMemberControl {
    ...
    public function recharge_addOp(){
        if (!chksubmit()){
            ...
            Tpl::showpage('predeposit/predeposit.pd_add');
            exit();
        }
        ...
        $data['pdr_member_id'] = $_SESSION['seller_session_info']['member_id'];
        $data['pdr_member_name'] = $_SESSION['seller_session_info']['member_name'];
    ...
    public function indexOp(){
        $condition = array();
        $condition['pdr_member_id'] = $_SESSION['seller_session_info']['member_id'];
        ...
        Tpl::showpage('predeposit/predeposit.pd_list');
    }
    ...
    public function recharge_showOp(){
        ...
        Tpl::showpage('predeposit/predeposit.pd_info');
    }
    ...
    public function pd_log_listOp(){
        $model_pd = Model('predeposit');
        $condition = array();
        $condition['lg_member_id'] = $_SESSION['seller_session_info']['member_id'];
        ...
        Tpl::output('show_page',$model_pd->showpage());
        Tpl::output('list',$list);
        Tpl::showpage('predeposit/predeposit.pd_log_list');
    }
    ...
    public function rcb_log_listOp()
    {
        ...
        $list = $model->table('rcb_log')->where(array(
            'member_id' => $_SESSION['seller_session_info']['member_id'],
        ...
        Tpl::output('list', $list);
        Tpl::showpage('predeposit/predeposit.rcb_log_list');
    }
    ...
    public function pd_cash_addOp(){
        if (chksubmit()){
            ...
            $member_info = $model_member->getMemberInfoByID($_SESSION['seller_session_info']['member_id']);
            //验证支付密码
            ...
            try {
                ...
                $data = array();
                $data['pdc_sn'] = $pdc_sn;
                $data['pdc_member_id'] = $_SESSION['seller_session_info']['member_id'];
                $data['pdc_member_name'] = $_SESSION['seller_session_info']['member_name'];
    ...
    public function pd_cash_listOp(){
        $condition = array();
        $condition['pdc_member_id'] =  $_SESSION['seller_session_info']['member_id'];
        ...
        Tpl::output('show_page',$model_pd->showpage());
        Tpl::showpage('predeposit/predeposit.pd_cash_list');
    }
    ...
    public function pd_cash_infoOp(){
        ...
        Tpl::output('info',$info);
        Tpl::showpage('predeposit/predeposit.pd_cash_info');
    }
