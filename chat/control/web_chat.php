...
class web_chatControl extends BaseControl
{
    ...
    public function get_user_listOp()
    {
        ...
        $member_list = $model_chat->getRecentList(['f_id' => $f_id, 'add_time' => ['egt', $add_time30]], 10, $member_list);
        $member_list = $model_chat->getRecentFromList(['t_id' => $f_id, 'add_time' => ['egt', $add_time30]], 10, $member_list);
