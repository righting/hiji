...
class goodsControl extends SystemControl{
    private $links = array(
        array('url'=>'controller=goods&action=goods','text'=>'所有商品'),
        array('url'=>'controller=goods&action=lockup_list','text'=>'违规下架'),
        array('url'=>'controller=goods&action=waitverify_list','text'=>'等待审核'),
        array('url'=>'controller=goods&action=goods_set','text'=>'商品设置'),
    );
    ...
    public function get_xmlOp() {
        ...
        foreach ($goods_list as $value) {
            ...
            if($value['is_select'] ==  '1'){
                $operation .= "<li><a href='javascript:void(0)' onclick=\"fg_set_yx('" . $value['goods_commonid'] . "')\">取消精选</a></li>";
            }else{
                $operation .= "<li><a href='javascript:void(0)' onclick=\"fg_set_yx('" . $value['goods_commonid'] . "')\">设为精选</a></li>";
            }
            /**设为精选尖货**/
            $operation .= "</ul>";
            ...
            $param['is_select'] = ($value['is_select'] ==  '1') ? '是' : '否';
...
//            $param['is_select'] = ($value['is_select'] ==  '1') ? '<span class="yes"><i class="fa fa-check-circle"></i>是</span>' : '<span class="no"><i class="fa fa-ban"></i>否</span>';
