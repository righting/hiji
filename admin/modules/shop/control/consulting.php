...
class consultingControl extends SystemControl{
    private $links = array(
            array('url'=>'controller=consulting&action=consulting','text'=>'咨询管理'),
            array('url'=>'controller=consulting&action=type_list','text'=>'类型设置'),
            array('url'=>'controller=consulting&action=setting','text'=>'头部文字设置')
    );
    public function __construct(){
        parent::__construct();
        Language::read('consulting');
        if ($_GET['action'] == 'index') $_GET['action'] = 'consulting';
