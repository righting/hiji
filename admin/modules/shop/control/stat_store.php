...
class stat_storeControl extends SystemControl{
    private $links = array(
        array('url'=>'controller=stat_store&action=newstore','lang'=>'stat_newstore'),
        array('url'=>'controller=stat_store&action=hotrank','lang'=>'stat_storehotrank'),
        array('url'=>'controller=stat_store&action=storesales','lang'=>'stat_storesales'),
        array('url'=>'controller=stat_store&action=degree','lang'=>'stat_storedegree'),
        array('url'=>'controller=stat_store&action=storearea','lang'=>'stat_storearea'),
    );
    ...
    public function __construct(){
        ...
        //处理搜索时间
        if (in_array($_REQUEST['action'],array('hotrank','storesales','get_storesales_xml','storesales_list','storesales_trends'))){
    ...
    public function newstoreOp(){
        //导出excel连接地址
        $actionurl = 'index.php?controller=stat_store&action=newstore';
        $where = array();
        //所属店铺分类
    ...
    public function showstoreOp(){
        ...
        $this->links[] = array('url'=>'controller=stat_store&action=showstore','lang'=>'stat_storelist');
    ...
    public function storeareaOp(){
        ...
        Tpl::output('stat_json',$stat_json);
        Tpl::output('statlist',$statlist);
        $actionurl = 'index.php?controller=stat_store&action=showstore&type=storearea';
        if (trim($_GET['search_time'])){
