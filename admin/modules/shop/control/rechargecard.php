...
<a class="btn green confirm-del-on-click" href="javascript:;" data-href="index.php?controller=rechargecard&action=del_card&id={$val['id']}"><i class="fa fa-trash"></i>删除</a>
EOB;
    ...
    public function export_step1Op()
    {
        ...
        if (!is_numeric($_GET['curpage'])) {
            ...
            if ($count > self::EXPORT_SIZE) {
                ...
                Tpl::output('murl', 'index.php?controller=rechargecard&action=index');
				Tpl::setDirquna('shop');/*创 驰 云 网 络 ccynet.com*/
    ...
    public function log_export_step1Op()
    {
        ...
        if (!is_numeric($_GET['curpage'])){
            ...
            if ($count > self::EXPORT_SIZE ){
                ...
                Tpl::output('list',$array);
                Tpl::output('murl','index.php?controller=rechargecard&action=log_list');
				Tpl::setDirquna('shop');/*创 驰 云 网 络 ccynet.com*/
                Tpl::showpage('export.excel');
                return;
