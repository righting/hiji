...
class uploadControl extends SystemControl{
    private $links = array(
        array('url'=>'controller=upload&action=param','lang'=>'upload_param'),
        array('url'=>'controller=upload&action=default_thumb','lang'=>'default_thumb'),
        array('url'=>'controller=upload&action=font','lang'=>'font_set')
    );
