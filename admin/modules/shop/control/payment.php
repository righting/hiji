...
//        $where['payment_code'] = array('neq','predeposit');
//        $where = [];
        $payment_list = $model_payment->getPaymentList($where);
    ...
    public function editOp(){
        ...
        if (chksubmit()){
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?controller=payment&action=index');
        }
