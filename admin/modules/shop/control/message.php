...
{
    private $links = [
        ['url' => 'controller=message&action=seller_tpl', 'lang' => 'seller_tpl'],
        ['url' => 'controller=message&action=member_tpl', 'lang' => 'member_tpl'],
    ];
    ...
    public function seller_tpl_editOp()
    {
        ...
        $this->links[] = ['url' => 'controller=message&action=seller_tpl_edit', 'lang' => 'seller_tpl_edit'];
    ...
    public function member_tpl_editOp()
    {
        ...
        $this->links[] = ['url' => 'controller=message&action=member_tpl_edit', 'lang' => 'member_tpl_edit'];
