...
class stat_industryControl extends SystemControl{
    private $links = array(
        array('url'=>'controller=stat_industry&action=scale','lang'=>'stat_industryscale'),
        array('url'=>'controller=stat_industry&action=rank','lang'=>'stat_industryrank'),
        array('url'=>'controller=stat_industry&action=price','lang'=>'stat_industryprice'),
        array('url'=>'controller=stat_industry&action=general','lang'=>'stat_industrygeneral'),
    );
    ...
    public function __construct(){
        ...
        //处理搜索时间
        if (!isset($this->search_arr['action']) || in_array($this->search_arr['action'],array('scale','rank','price'))){
        ...
        if (!isset($this->search_arr['action']) || in_array($this->search_arr['action'],array('scale','general'))){//仅显示前两级分类
            $show_depth = 2;
        }
