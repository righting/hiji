...
class stat_goodsControl extends SystemControl{
    private $links = array(
        array('url'=>'controller=stat_goods&action=pricerange','lang'=>'stat_goods_pricerange'),
        array('url'=>'controller=stat_goods&action=hotgoods','lang'=>'stat_hotgoods'),
        array('url'=>'controller=stat_goods&action=goods_sale','lang'=>'stat_goods_sale'),
    );
    ...
    public function __construct(){
        ...
        //处理搜索时间
        if (!isset($this->search_arr['action']) || in_array($this->search_arr['action'],array('pricerange','hotgoods','goods_sale','get_goods_xml'))){
