...
class evaluateControl extends SystemControl{
    private $links = array(
            array('url'=>'controller=evaluate&action=evalgoods_list','text'=>'来自买家的评价'),
            array('url'=>'controller=evaluate&action=evalstore_list','text'=>'店铺动态评价')
    );
    public function __construct() {
        parent::__construct();
        Language::read('evaluate');
        if ($_GET['action'] == 'index') $_GET['action'] = 'evalgoods_list';
