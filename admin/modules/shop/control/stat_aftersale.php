...
{
    private $links = [
        ['url' => 'controller=stat_aftersale&action=refund', 'lang' => 'stat_refund'],
        //['url' => 'controller=stat_aftersale&action=evalstore', 'lang' => 'stat_evalstore'],
    ];
    ...
    public function __construct()
    {
        ...
        //处理搜索时间
        if (!isset($this->search_arr['action']) || in_array($this->search_arr['action'], ['refund', 'refundlist', 'get_refundlist_xml', 'get_refund_highcharts'])) {
    ...
    public function get_refundlist_xmlOp()
    {
        ...
        if (!empty($list) && is_array($list)) {
            $fields_array = ['order_sn', 'refund_sn', 'store_name', 'goods_name', 'buyer_name', 'add_time', 'refund_amount', 'seller_state', 'refund_state'];
            foreach ($list as $k => $v) {
