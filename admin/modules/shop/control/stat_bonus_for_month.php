...
class stat_bonus_for_monthControl extends SystemControl
{
...
//        }
    ...
    public function indexsOp()
    {
        ...
        if ($this->getType == 'xml') {
            ...
            $data['total_num'] = count($user_money_pool_model->where($where)->field($field)->group('to_user_id')->order('updated_at desc')->select());
            $data['list']      = $new_list;
            echo Tpl::flexigridXML($data);
            die;
        }
