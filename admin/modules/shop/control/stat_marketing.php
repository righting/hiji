...
class stat_marketingControl extends SystemControl{
    private $links = array(
        array('url'=>'controller=stat_marketing&action=promotion','lang'=>'stat_promotion'),
        array('url'=>'controller=stat_marketing&action=group','lang'=>'stat_group'),
    );
    ...
    public function __construct(){
        ...
        //处理搜索时间
        if (!isset($this->search_arr['action']) || in_array($this->search_arr['action'],array('promotion','group','get_groupgoods_xml','groupgoods','get_grouplist_xml'))){
