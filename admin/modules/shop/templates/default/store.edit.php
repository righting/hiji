...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?controller=store&action=store" title="返回<?php echo $lang['manage'];?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <h3>编辑店铺信息</h3>
      ...
      <div class="ncap-form-default">
        <dl class="row">
          ...
          <dl class="row">
              ...
              <dd class="opt"><input type="text" name="seller_password" value="" class="input-txt"/><span class="err"></span>
                  <p class="notic">请使用 数字、字母、下划线组成大于等于6个字符的密码，留空不修改密码</p>
              </dd>
          </dl>
        <dl class="row">
          <dt class="tit">
    ...
    <form id="joinin_form" enctype="multipart/form-data" method="post" action="index.php?controller=store&action=edit_save_joinin" style="display:none;">
      <input type="hidden" name="form_submit" value="ok" />
