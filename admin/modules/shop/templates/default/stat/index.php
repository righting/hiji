...
function update_flex(){
    ...
    $("#flexigrid").flexigrid({
        url: "<?php echo urlAdminShop('stat_consumption','index',['get_type'=>'xml'])?>&"+$("#formSearch").serialize(),
        colModel : [
                ...
                {display: '消费金额', name : 'total_money',  width : 80, sortable : true, align: 'center'},
                {display: '时间', name : 'created_at',  width : 280, sortable : true, align: 'center'}
            ],
        buttons : [
...
function fg_operation(name, bDiv){
    var stat_url = "<?php echo urlAdminShop('stat_consumption','index')?>";
