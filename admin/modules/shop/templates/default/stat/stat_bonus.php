...
function update_flex(){
    $('.ncap-stat-general-single').load("<?php echo urlAdminShop('stat_bonus',$output['action'],['get_type'=>'xml','bonus_type'=>$output['this_type']])?>&" + $("#formSearch").serialize(),
        function () {
            $('.timer').each(count);
        });

    $("#flexigrid").flexigrid({
        url: "<?php echo urlAdminShop('stat_bonus',$output['action'],['get_type'=>'xml','bonus_type'=>$output['this_type']])?>&"+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = "<?php echo urlAdminShop('stat_bonus',$output['action'],['bonus_type'=>$output['this_type']])?>";
