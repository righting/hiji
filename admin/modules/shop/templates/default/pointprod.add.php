  ...
  <form id="pointprod_form" method="post" enctype="multipart/form-data" >
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dl class="row">
            <dt class="tit">
                <label for="goodsserial"><em>*</em><?php echo $lang['admin_pointprod_shipping_fee']; ?></label>
            </dt>
            <dd class="opt">
                <input type="text" name="shipping_fee" id="goodsserial" class="input-txt"/>
                <span class="err"></span>
                <p class="notic"></p>
            </dd>
        </dl>
        <dl class="row">
            <dt class="tit">
                <label for="goodsserial"><em>*</em><?php echo $lang['admin_pointprod_service_charge']; ?></label>
            </dt>
            <dd class="opt">
                <input type="text" name="service_charge" id="goodsserial" class="input-txt" value="9.9"/>
                <span class="err"></span>
                <p class="notic"></p>
            </dd>
        </dl>
...
$(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?controller=pointprod&action=pointprod_pic_upload',
...
function del_file_upload(file_id)
{
    ...
    $.getJSON('index.php?controller=pointprod&action=ajaxdelupload&file_id=' + file_id, function(result){
        if(result){
            $('#' + file_id).remove();
        }else{
