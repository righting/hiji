...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?controller=store&action=get_joinin_xml',
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},


            {display: '邀请人ID', name : 'invite_id', width : 150, sortable : false, align : 'left'},
            {display: '绑定手机号', name : 'bind_mobile', width : 80, sortable : false, align : 'left'},
