  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?controller=brand&action=brand_apply"><?php echo $lang['brand_index_to_audit'];?></a></li>
      </ul>
    </div>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?controller=brand&action=get_xml',
        colModel : [
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?controller=brand&action=brand_add';
    }
    if (name == 'csv') {
