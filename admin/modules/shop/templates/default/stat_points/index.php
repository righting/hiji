...
<div class="page">
    ...
    <div class="ncap-form-all ncap-stat-general" style="padding: 10px;">
        <!--<div class="title">
            <h3>平台积分统计</h3>
        </div>-->
        <dl class="row">
            <dd class="opt">
                <ul class="nc-row">
                    <li title="平台总积分：<?php echo $output['points_info']['total_points'];?>">
                        <h4 style="font-weight: bold;">平台总积分</h4>
                        <h6>平台总积分</h6>
                        <h2 class="timer" id="count-number"  data-to="<?php echo $output['points_info']['total_points'];?>" data-speed="1500"></h2>
                    </li>
                    <li title="海豚主场积分：<?php echo $output['points_info']['total_member_points'];?>">
                        <h4 style="font-weight: bold;">海豚主场积分</h4>
                        <h6>海豚主场积分</h6>
                        <h2 class="timer" id="count-number"  data-to="<?php echo $output['points_info']['total_member_points'];?>" data-speed="1500"></h2>
                    </li>
                    <li title="非海豚主场积分：<?php echo $output['points_info']['total_member_h_points'];?>">
                        <h4 style="font-weight: bold;">非海豚主场积分</h4>
                        <h6>非海豚主场积分</h6>
                        <h2 class="timer" id="count-number"  data-to="<?php echo $output['points_info']['total_member_h_points'];?>" data-speed="1500"></h2>
                    </li>
    ...
    <div id="flexigrid" style="padding: 10px;"></div>
...
function update_flex(){
    $('.ncap-stat-general-single').load("<?php echo urlAdminShop('stat_points','index',['get_type'=>'xml'])?>&" + $("#formSearch").serialize(),
        function () {
            $('.timer').each(count);
        });

    $("#flexigrid").flexigrid({
        url: "<?php echo urlAdminShop('stat_points','index',['get_type'=>'xml'])?>&"+$("#formSearch").serialize(),
        colModel : [
            ...
            {display: '积分', name : 'points',  width : 80, sortable : true, align: 'center'},
            {display: '描述', name : 'pl_desc',  width : 300, sortable : true, align: 'center'},
            {display: '操作时间', name : 'created_at',  width : 200, sortable : true, align: 'center'}
            ],
        buttons : [
...
function fg_operation(name, bDiv){
    var stat_url = "<?php echo urlAdminShop('stat_points','index')?>";
