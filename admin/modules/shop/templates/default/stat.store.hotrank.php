...
<div class="page">
  ...
  <div class="ncap-search-bar">
    ...
    <input type="hidden" name="action" value="hotrank" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?controller=stat_store&action=hotrank_list&type='+type+'&search_sclass='+search_sclass+'&t=<?php echo $output['searchtime'];?>');
}
</script>