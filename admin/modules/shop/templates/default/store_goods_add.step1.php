...
<div class="wrapper_search">
  <div class="wp_sort">
    ...
    <a  class="ncbtn ncbtn-mint" href="<?php echo urlShop('store_info','bind_class') ?>">申请商品分类</a>
  <div class="alert">
  ...
  <div class="wp_confirm">
    <form method="get">
      <?php if ($output['edit_goods_sign']) {?>
      <input type="hidden" name="controller" value="store_goods_online" />
      <input type="hidden" name="action" value="edit_goods" />
      <input type="hidden" name="commonid" value="<?php echo $output['commonid'];?>" />
      <input type="hidden" name="ref_url" value="<?php echo $_GET['ref_url'];?>" />
      <?php } else {?>
      <input type="hidden" name="controller" value="jfgoods_add" />
      <input type="hidden" name="action" value="add_step_two" />
      <?php }?>
...
<script src="<?php echo SHOP_RESOURCE_SITE_URL;?>/js/jfgoods_add.step1.js"></script> 
<script>
