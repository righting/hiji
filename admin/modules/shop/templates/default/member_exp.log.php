  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?controller=member_exp&action=expsetting">规则设置</a></li>
        <li><a href="index.php?controller=member_exp&action=member_grade">等级设定</a></li>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?controller=member_exp&action=get_xml',
        colModel : [
