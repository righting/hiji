  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?controller=brand&action=brand"><?php echo $lang['nc_manage'];?></a></li>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?controller=brand&action=get_xml&type=apply',
        colModel : [
...
function fg_apply(id) {
    ...
    $.getJSON('index.php?controller=brand&action=brand_apply_set', {id:id}, function(data){
        if (data.state) {
...
function fg_del(id) {
    ...
    $.getJSON('index.php?controller=brand&action=brand_del', {id:id}, function(data){
        if (data.state) {
            $("#flexigrid").flexReload();
        } else {
            showError(data.msg)
