      ...
      <dd class="opt">
        <ul class="nc-row">
          ...
          <li title="商品数量：<?php echo $output['statnew_arr']['goodsnum'];?>">
            ...
            <li title="平台提成：<?php echo $output['statnew_arr']['platform_profit'];?>">
                <a href="/admin/modules/shop/index.php?controller=get_platform_profit">
                    <div>
                        <h4>平台提成</h4>
                        <h6>平台历史总提成</h6>
                        <h2 class="timer" id="count-number"  data-to="<?php echo $output['statnew_arr']['platform_profit'];?>" data-speed="1500" ></h2>
                    </div>
                </a>
            </li>
        <li title="平台分红：<?php echo $output['statnew_arr']['bonus_total'];?>">
            <a href="/admin/modules/shop/index.php?controller=stat_bonus_log">
                <div>
                    <h4>平台分红</h4>
                    <h6>平台历史总分红</h6>
                    <h2 class="timer" id="count-number"  data-to="<?php echo $output['statnew_arr']['bonus_total'];?>" data-speed="1500" ></h2>
                </div>
            </a>
        </li>
        <li title="平台资金池：<?php echo $output['statnew_arr']['prdf'];?>">
            <h4>平台资金池</h4>
            <h6>平台当前资金池总额</h6>
            <h2 class="timer" id="count-number"  data-to="<?php echo $output['statnew_arr']['prdf'];?>" data-speed="1500" ></h2>
        </li>
        </ul>
    </dl>
  </div>
