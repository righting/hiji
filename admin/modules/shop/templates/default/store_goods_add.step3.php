...
<?php }?>
<form method="post" id="goods_image" action="<?php if ($output['edit_goods_sign']) { echo urlAdminShop('jfgoods_add', 'edit_save_image'); } else { echo urlAdminShop('jfgoods_add', 'save_image');}?>">
    ...
    <div class="container">
      ...
      <div class="ncsc-goodspic-list">
        ...
        <div class="ncsc-select-album">
          <a class="ncbtn" href="index.php?controller=store_album&action=pic_list&item=goods_image&color_id=<?php echo $value['sp_value_id'];?>" nctype="select-<?php echo $value['sp_value_id'];?>"><i class="icon-picture"></i>从图片空间选择</a>
...
<script type="text/javascript" src="<?php echo SHOP_RESOURCE_SITE_URL;?>/js/jfgoods_add.step3.js" charset="utf-8"></script>
<script>
