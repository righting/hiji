...
<ul class="dialog-goodslist-s2">
  ...
  <li>
    <div onclick="select_recommend_goods(<?php echo $v['goods_id'];?>);" class="goods-pic"><span class="ac-ico"></span><span class="thumb size-72x72"><i></i>
        <img goods_id="<?php echo $v['goods_id'];?>" goods_price="<?php echo $v['goods_price'];?>" market_price="<?php echo $v['goods_marketprice'];?>" goods_salenum="<?php echo $v['goods_salenum']; ?>"
        title="<?php echo $v['goods_name'];?>" goods_name="<?php echo $v['goods_name'];?>" src="<?php echo $v['goods_image'];?>" onload="javascript:DrawImage(this,72,72);" /></span></div>
