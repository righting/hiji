  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle-s">
          <a class="btn blue" href="index.php?controller=sns_sharesetting&action=edit&state=1&key=<?php echo $k; ?>"><i class="fa fa-pencil-square-o"></i> <?php echo $lang['nc_edit']?></a></td>
