...
<div class="page">
  ...
  <div class="ncap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      ...
      <input type="hidden" name="action" value="hotgoods" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?controller=stat_goods&action=hotgoods_list&type='+type+'&choose_gcid='+choose_gcid+'&t=<?php echo $output['searchtime'];?>');
}
