  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?controller=points&action=pointslog"><?php echo $lang['admin_points_log_title']?></a></li>
        <li><a href="index.php?controller=points&action=setting">规则设置</a></li>
...
function checkmember(){
	...
	$.getJSON("index.php?controller=points&action=checkmember", {'name':membername}, function(data){
	        if (data)
	        {
		        $("#tr_memberinfo").show();
