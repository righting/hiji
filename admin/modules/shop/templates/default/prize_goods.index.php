...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?controller=prize_goods&action=get_xml&type=<?php echo $output['type'];?>',
        colModel : [
            {display: '操作', name : 'operation', width : 150, sortable : false, align: 'center', className: 'handle'},
            {display: '奖品编号', name : 'id', width : 100, sortable : true, align: 'center'},
            ...
            {display: '奖品概率', name : 'prize_percent', width : 130, sortable : true, align: 'center'},
            {display: '奖品排序', name : 'prize_sort', width : 130, sortable : true, align: 'center'},
            ],
        sortname: "prize_sort",
        sortorder: "desc",
        title: '奖品列表'
