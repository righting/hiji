    ...
    <div class="tabs-panels">
      <div class="misc-info">
        <dl>
          ...
          <dd><a href="index.php?controller=order&action=show_order&order_id=<?php echo $output['order_info']['order_id'];?>"> <?php echo $output['order_info']['order_sn'];?></a></dd>
      ...
      <div class="tabs-panels">
        <div class="goods-info">
          ...
          <table>
            ...
            <tr>
              <td width="65" align="center" valign="middle"><a style="text-decoration:none;" href="<?php echo urlShop('goods','index',array('goods_id'=> $val['goods_id']));?>" target="_blank"> <img width="50" src="<?php echo cthumb($val['goods_image'],60);?>" /> </a></td>
      ...
      <dd class="opt">
        <?php
                        if(empty($output['complain_info']['complain_pic1'])&&empty($output['complain_info']['complain_pic2'])&&empty($output['complain_info']['complain_pic3'])) {
                            ...
                            $pic_link = 'index.php?controller=show_pics&type=complain&pics=';
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?controller=complain&action=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?controller=complain&action=publish_complain_talk',
                cache:false,
...
function forbit_talk(talk_id) {
        $.ajax({
            type:'POST',
                url:'index.php?controller=complain&action=forbit_talk',
                cache:false,
  ...
  <div class="ncap-form-default">
    ...
    <dl class="row" id="close_complain">
      ...
      <form method='post' id="verify_form" action="index.php?controller=complain&action=complain_verify">
    ...
    <form method='post' id="close_form" action="index.php?controller=complain&action=complain_close">
