...
function update_flex(){
    ...
    $("#flexigrid").flexigrid({
        url: 'index.php?controller=stat_industry&action=get_general_xml&choose_gcid='+choose_gcid,
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?controller=stat_industry&action=general_list';
