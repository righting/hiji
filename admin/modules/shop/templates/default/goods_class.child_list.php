...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?controller=goods_class&action=goods_class&gc_id=<?php echo $output['parent_id']?>" title="返回上级分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?controller=goods_class&action=goods_class_add&gc_parent_id=<?php echo $output['gc_id']?>';
    }
    if (name == 'del') {
