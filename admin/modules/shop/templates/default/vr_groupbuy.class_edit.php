...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="index.php?controller=vr_groupbuy&action=class_list" title="返回列表">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?controller=vr_groupbuy&action=class_edit">
