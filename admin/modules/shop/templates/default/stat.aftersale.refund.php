...
function update_flex(){
	$('#container').load('index.php?controller=stat_aftersale&action=get_refund_highcharts&'+$("#formSearch").serialize());
    $("#flexigrid").flexigrid({
        url: 'index.php?controller=stat_aftersale&action=get_refundlist_xml&'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?controller=stat_aftersale&action=refundlist';
