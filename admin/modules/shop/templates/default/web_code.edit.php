...
<div class="page">
    ...
    <div class="ncap-form-all">
        <div class="title">
            ...
            <a href="index.php?controller=web_config&action=web_edit&web_id=<?php echo $output['web_array']['web_id']; ?>">设置该板块色彩</a>
        </div>
        <dl class="row">
            <dt class="tit">
                ...
                <div class="home-templates-board-layout style-<?php echo $output['web_array']['style_name']; ?>">
                    ...
                    <div class="left">
                        <dl id="left_tit">
                            ...
                            <a href="JavaScript:show_dialog('upload_tit');"><i
                                        class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit']; ?></a></dt>
                            <dd class="tit-txt"
                            ...
                            <dd class="tit-pic"
                                <?php if ($output['code_tit']['code_info']['type'] == 'txt'){ ?>style="display:none;"<?php } ?>>
                                <div id="picture_tit" class="picture"><img
                                            src="<?php echo $output['code_tit']['code_info']['pic']; ?>"/>
                                </div>
                            </dd>
                        </dl>
                        ...
                        <dl >
                            ...
                            <a href="JavaScript:show_dialog('category_list');"><i
                                        class="icon-th"></i><?php echo $lang['nc_edit']; ?></a></dt>
                                ...
                                <?php if (is_array($output['code_category_list']['code_info']['goods_class']) && !empty($output['code_category_list']['code_info']['goods_class'])) { ?>
                                    <ul>
                                        <?php foreach ($output['code_category_list']['code_info']['goods_class'] as $k => $v) { ?>
                                            <li title="<?php echo $v['gc_name']; ?>"><a
                                                        href="javascript:void(0);"><?php echo $v['gc_name']; ?></a></li>
                                        <?php } ?>
                                    </ul>
                                <?php } else { ?>
                                    <ul>
                                        <li><a href="javascript:void(0);"><?php echo $lang['web_config_gc_name']; ?></a>
                                        </li>
                                        <li><a href="javascript:void(0);"><?php echo $lang['web_config_gc_name']; ?></a>
                                        </li>
                                        <li><a href="javascript:void(0);"><?php echo $lang['web_config_gc_name']; ?></a>
                                    ...
                                    <dl recommend_id="<?php echo $key; ?>">
                                        ...
                                        <a href="JavaScript:del_recommend(<?php echo $key; ?>);"><i
                                                ...
                                                href="JavaScript:show_recommend_dialog(<?php echo $key; ?>);"><i
                                                    class="fa fa-shopping-cart"></i><?php echo '商品块'; ?></a> <a
                                                href="JavaScript:show_recommend_pic_dialog(<?php echo $key; ?>);"><i
                                                    class="icon-lightbulb"></i><?php echo '广告块'; ?></a> </dt>
                                        <dd>
                    ...
                    <div class="ccy-btbrand" style="display:none ">
                        <dl>
                            <dt>
                            <h4><?php echo $lang['web_config_brand_title']; ?></h4>
                            <a href="JavaScript:show_dialog('brand_list');"><i
                                        class="icon-ticket"></i><?php echo $lang['nc_edit']; ?></a></dt>
                            <dd>
                                <ul class="brands">
                                    <?php if (is_array($output['code_brand_list']['code_info']) && !empty($output['code_brand_list']['code_info'])) { ?>
                                        <?php foreach ($output['code_brand_list']['code_info'] as $key => $val) { ?>
                                            <li><span><img title="<?php echo $val['brand_name']; ?>"
                                                           src="<?php echo $val['brand_pic']; ?>"/> </span>
                                            </li>
                                        <?php } ?>
                                    <?php } else { ?>
