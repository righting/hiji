            ...
            <?php if (!empty($output['mmtpl_list'])) { ?>
                <?php foreach ($output['mmtpl_list'] as $val) { ?>
                    <tr>
                        ...
                        <td class="handle-s"><a class="btn blue"
                                                href="<?php echo urlAdminShop('message', 'member_tpl_edit', ['code' => $val['mmt_code']]); ?>"><i
                                        class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit']; ?></a></td>
