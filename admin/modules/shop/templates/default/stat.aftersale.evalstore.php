...
function update_flex(){
    $("#flexigrid").flexigrid({
        url: 'index.php?controller=stat_aftersale&action=get_evalstore_xml&'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?controller=stat_aftersale&action=evalstore';
