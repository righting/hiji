...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?controller=goods_recommend&action=get_xml',
        colModel : [
...
function fg_operate(name, bDiv) {
    if (name == 'del') {
    	...
    	window.location.href = 'index.php?controller=goods_recommend&action=add';
    }
}
...
function fg_delete(id) {
	...
	$.ajax({
        type: "GET",
        dataType: "json",
        url: "index.php?controller=goods_recommend&action=delete",
        data: "del_id="+id,
