  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?controller=web_config&action=member_homeAdv"><?php echo '会员中心广告';?></a></li>
        <li><a href="index.php?controller=web_config&action=pl_recommend"><?php echo '平台商品推荐';?></a></li>
        <li><a href="index.php?controller=web_config&action=htIndex"><?php echo '海豚主场';?></a></li>
      </ul>
    </div>
  </div>
  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle">
            <a class="btn purple" href="<?= urlAdminShop('web_config','web_edit',['web_id'=>$v['web_id']]) ?>"><i class="fa fa-cog"></i><?php echo $lang['web_config_web_edit'];?></a>
            <a class="btn orange" href="<?= urlAdminShop('web_config','code_edit',['web_id'=>$v['web_id'],'type'=>$v['web_page']]) ?>"><i class="fa fa-steam"></i><?php echo $lang['web_config_code_edit'];?></a>
        </td>
