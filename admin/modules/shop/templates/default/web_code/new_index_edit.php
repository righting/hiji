                ...
                <div class="line-tz hover-box">
                    ...
                    <h3>
                        ...
                        <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][1]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][1]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][1]['code_id'] ?>" data-type="<?php echo $output['lists'][1]['code_info_arr']['type'] ?>" class="edit-btn">
                            <span style="display: none" data-title="<?php echo $output['lists'][1]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][1]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][1]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][1]['code_info_arr']['pic'] ?>"  >
                            </span>编辑
                        </a>
                    </h3>
                    ...
                    <h3>
                        <span>热销产品推荐</span>
                        <em>HOT SALE</em>
                        <a href="javascript:;" id="edit-btn-1" data-id="1" data-code-id="" data-type="1" class="edit-btn">
                    <span style="display: none" data-title="热销产品推荐" data-f-title="HOT SALE" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img1.png">
                    </span>编辑
                        </a>
                    </h3>
                ...
                <div class="line-tz2 hover-box">
                    ...
                    <h3>
                        ...
                        <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][2]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][2]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][2]['code_id'] ?>" data-type="<?php echo $output['lists'][2]['code_info_arr']['type'] ?>" class="edit-btn">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json='<?php echo $output['lists'][2]['pic_list_json']; ?>'>
                            </span>编辑
                        </a>
                    </h3>
                    <div class="line-tz-img">
                        <?php if(!empty($output['lists'][2]['code_info_arr']['pic_arr'])){ ?>
                            <?php foreach ($output['lists'][2]['code_info_arr']['pic_arr'] as $pic_info){ ?>
                        <img src="<?php echo $pic_info['pic'] ?>" style="height: 100px;width: 100px;display: block;float: left;margin: 5px 5px">
                            <?php } ?>
                        <?php } ?>
                    </div>
                    ...
                    <h3>
                        ...
                        <a href="javascript:;" id="edit-btn-2" data-id="2" data-code-id="" data-type="3" class="edit-btn">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''>
                            </span>编辑
                        </a>
                    </h3>
                    <div class="line-tz-img">
                        <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img2.png" style="height: 100px;width: 100px;display: block;float: left;margin: 5px 5px">
                    </div>
                    <?php } ?>
                </div>
                ...
                <div class="line-tz3 hover-box">
                    ...
                    <?php if(in_array(3,$output['var_name_arr'])){  ?>
                        <h3>
                            ...
                            <span style="display: none" data-title="<?php echo $output['lists'][3]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][3]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][3]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][3]['code_info_arr']['pic'] ?>"  >
                            </span>编辑
                            </a>
                        </h3>
                    ...
                    <?php }else{ ?>
                        <h3><span>美丽人生</span><em>LIFE IS BEAUTIFUL</em>
                            <a href="javascript:;" id="edit-btn-3" data-id="3" data-code-id="" data-type="1" class="edit-btn">
                            <span style="display: none" data-title="美丽人生" data-f-title="LIFE IS BEAUTIFUL" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img3.png">
                            </span>编辑</a>
                        </h3>
                ...
                <div class="line-tz4 hover-box">
                    ...
                    <h3>
                        ...
                        <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][4]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][4]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][4]['code_id'] ?>" data-type="<?php echo $output['lists'][4]['code_info_arr']['type'] ?>" class="edit-btn">
                            <span style="display: none" data-title="<?php echo $output['lists'][4]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][4]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][4]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][4]['code_info_arr']['pic'] ?>"  >
                            </span>编辑
                        </a>
                    </h3>
                    ...
                    <h3>
                        ...
                        <a href="javascript:;" id="edit-btn-4" data-id="4" data-code-id="" data-type="1" class="edit-btn">
                            <span style="display: none" data-title="潮店酷玩" data-f-title="TIDAL POWER COLDPLAY" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img4.png">
                            </span>编辑</a>
                    </h3>
                ...
                <div class="line-tz5 hover-box">
                    ...
                    <h3>
                        ...
                        <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][5]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][5]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][5]['code_id'] ?>" data-type="<?php echo $output['lists'][5]['code_info_arr']['type'] ?>" class="edit-btn">
                            <span style="display: none" data-title="<?php echo $output['lists'][5]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][5]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][5]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][5]['code_info_arr']['pic'] ?>"  >
                            </span>编辑
                        </a>
                    </h3>
                    <div class="line-tz-img">
                        <img src="<?php echo $output['lists'][5]['code_info_arr']['pic'] ?>">
                    </div>
                    <div class="line-tz-text">
                        <span><?php echo $output['lists'][5]['code_info_arr']['title'] ?></span>
                        <em><?php echo $output['lists'][5]['code_info_arr']['f_title'] ?></em>
                    ...
                    <h3>
                        ...
                        <a href="javascript:;" id="edit-btn-5" data-id="5" data-code-id="" data-type="1" class="edit-btn">
                            <span style="display: none" data-title="居家生活" data-f-title="THE LIFE THAT OCCUPY THE HOME" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img5.png">
                            </span>编辑</a>
                    </h3>
                    <div class="line-tz-img">
                        <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img5.png">
                    </div>
                    <div class="line-tz-text">
                        <span>居家生活</span>
                        <em>THE LIFE THAT OCCUPY THE HOME</em>
                ...
                <span class="line-tz6 hover-box">
                    ...
                    <?php if(in_array(6,$output['var_name_arr'])){  ?>
                        <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][6]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][6]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][6]['code_id'] ?>" data-type="<?php echo $output['lists'][6]['code_info_arr']['type'] ?>" class="edit-btn">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json='<?php echo $output['lists'][6]['pic_list_json']; ?>'>
                            </span>编辑
                        </a>
                    <div class="line-tz6">
                        <ul>
                            <?php if(!empty($output['lists'][6]['code_info_arr']['pic_arr'])){ ?>
                                <?php foreach ($output['lists'][6]['code_info_arr']['pic_arr'] as $pic_info){ ?>
                                    <li><a href=""><img src="<?php echo $pic_info['pic'] ?>"></a></li>
                                <?php } ?>
                            <?php } ?>
                        </ul>
                    </div>
                    <?php }else{ ?>
                        <a href="javascript:;" id="edit-btn-6" data-id="6" data-code-id="" data-type="3" class="edit-btn">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''>
                            </span>编辑
                        </a>
                        <div class="line-tz6">
            ...
            <div class="guess">
                ...
                <ul>
                    ...
                    <?php if(in_array(7,$output['var_name_arr'])){  ?>
                        <li class="edit-btn" id="edit-btn-<?php echo $output['lists'][7]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][7]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][7]['code_id'] ?>" data-type="<?php echo $output['lists'][7]['code_info_arr']['type'] ?>">
                            <span style="display: none" data-title="<?php echo $output['lists'][7]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][7]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][7]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][7]['code_info_arr']['pic'] ?>"  ></span>
                            <a href="" style="width:460px;height: 265px;display: block">
                                <img src="<?php echo $output['lists'][7]['code_info_arr']['pic'] ?>">
                            </a>
                        </li>
                    <?php }else{ ?>
                        <li data-id="7" class="edit-btn" id="edit-btn-7" data-code-id="" data-type="1">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img10.png"></span>
                            <a href="" style="width:460px;height: 265px;display: block">
                                <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img10.png">
                            </a>
                        </li>
                    <?php } ?>
                    <!---------------------------------------------------------->
                    ...
                    <?php if(in_array(8,$output['var_name_arr'])){  ?>
                        <li class="edit-btn" id="edit-btn-<?php echo $output['lists'][8]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][8]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][8]['code_id'] ?>" data-type="<?php echo $output['lists'][8]['code_info_arr']['type'] ?>">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json='<?php echo $output["lists"][8]["pic_list_json"]; ?>'></span>
                            <a href="" style="width:220px;height: 527px;display: block">
                    ...
                    <?php }else{ ?>
                        <li data-id="8" class="edit-btn" id="edit-btn-8" data-code-id="" data-type="3">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''></span>
                            <a href="" style="width:220px;height: 527px;display: block">
                                <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img12.png">
                            </a>
                        </li>
                    <?php } ?>
                    <!---------------------------------------------------------->
                    ...
                    <?php if(in_array(9,$output['var_name_arr'])){  ?>
                        <li class="edit-btn" id="edit-btn-<?php echo $output['lists'][9]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][9]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][9]['code_id'] ?>" data-type="<?php echo $output['lists'][9]['code_info_arr']['type'] ?>">
                            <span style="display: none" data-title="<?php echo $output['lists'][9]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][9]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][9]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][9]['code_info_arr']['pic'] ?>"  ></span>
                            <a href="" style="width:220px;height: 265px;display: block">
                                <img src="<?php echo $output['lists'][9]['code_info_arr']['pic'] ?>">
                            </a>
                        </li>
                    <?php }else{ ?>
                        <li data-id="9" class="edit-btn" id="edit-btn-9" data-code-id="" data-type="1">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img13.png"></span>
                            <a href="" style="width:220px;height: 265px;display: block">
                                <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img13.png">
                            </a>
                        </li>
                    <?php } ?>
                    <!---------------------------------------------------------->
                    ...
                    <?php if(in_array(10,$output['var_name_arr'])){  ?>
                        <li class="edit-btn" id="edit-btn-<?php echo $output['lists'][10]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][10]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][10]['code_id'] ?>" data-type="<?php echo $output['lists'][10]['code_info_arr']['type'] ?>">
                            <span style="display: none" data-title="<?php echo $output['lists'][10]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][10]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][10]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][10]['code_info_arr']['pic'] ?>"  ></span>
                            <a href="" style="width:220px;height: 265px;display: block">
                                <img src="<?php echo $output['lists'][10]['code_info_arr']['pic'] ?>">
                            </a>
                        </li>
                    <?php }else{ ?>
                        <li data-id="10" class="edit-btn" id="edit-btn-10" data-code-id="" data-type="1">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img14.png"></span>
                            <a href="" style="width:220px;height: 265px;display: block">
                                <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img14.png">
                            </a>
                        </li>
                    <?php } ?>
                    <!---------------------------------------------------------->
                    ...
                    <?php if(in_array(11,$output['var_name_arr'])){  ?>
                        <li class="edit-btn" id="edit-btn-<?php echo $output['lists'][11]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][11]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][11]['code_id'] ?>" data-type="<?php echo $output['lists'][11]['code_info_arr']['type'] ?>">
                            <span style="display: none" data-title="<?php echo $output['lists'][11]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][11]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][11]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][11]['code_info_arr']['pic'] ?>"  ></span>
                            <a href="" style="width:220px;height: 265px;display: block">
                                <img src="<?php echo $output['lists'][11]['code_info_arr']['pic'] ?>">
                            </a>
                        </li>
                    <?php }else{ ?>
                        <li data-id="11" class="edit-btn" id="edit-btn-11" data-code-id="" data-type="1">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img15.png"></span>
                            <a href="" style="width:220px;height: 265px;display: block">
                                <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img15.png">
                            </a>
                        </li>
                    <?php } ?>
                    <!---------------------------------------------------------->
                    ...
                    <?php if(in_array(12,$output['var_name_arr'])){  ?>
                        <li class="edit-btn" id="edit-btn-<?php echo $output['lists'][12]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][12]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][12]['code_id'] ?>" data-type="<?php echo $output['lists'][12]['code_info_arr']['type'] ?>">
                            <span style="display: none" data-title="<?php echo $output['lists'][12]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][12]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][12]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][12]['code_info_arr']['pic'] ?>"  ></span>
                            <a href="" style="width:220px;height: 265px;display: block">
                                <img src="<?php echo $output['lists'][12]['code_info_arr']['pic'] ?>">
                            </a>
                        </li>
                    <?php }else{ ?>
                        <li data-id="12" class="edit-btn" id="edit-btn-12" data-code-id="" data-type="1">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img16.png"></span>
                            <a href="" style="width:220px;height: 265px;display: block">
                                <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img16.png">
                            </a>
                        </li>
                    <?php } ?>
                    <!---------------------------------------------------------->
                    ...
                    <?php if(in_array(13,$output['var_name_arr'])){  ?>
                        <li class="edit-btn" id="edit-btn-<?php echo $output['lists'][13]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][13]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][13]['code_id'] ?>" data-type="<?php echo $output['lists'][13]['code_info_arr']['type'] ?>">
                            <span style="display: none" data-title="<?php echo $output['lists'][13]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][13]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][13]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][13]['code_info_arr']['pic'] ?>"  ></span>
                            <a href="" style="width:460px;height: 265px;display: block">
                                <img src="<?php echo $output['lists'][13]['code_info_arr']['pic'] ?>">
                            </a>
                        </li>
                    <?php }else{ ?>
                        <li data-id="13" class="edit-btn" id="edit-btn-13" data-code-id="" data-type="1">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img11.png"></span>
                            <a href="" style="width:460px;height: 265px;display: block">
                                <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img11.png">
                            </a>
                        </li>
                    <?php } ?>
                    <!---------------------------------------------------------->
                    ...
                    <?php if(in_array(14,$output['var_name_arr'])){  ?>
                        <li class="edit-btn" id="edit-btn-<?php echo $output['lists'][14]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][14]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][14]['code_id'] ?>" data-type="<?php echo $output['lists'][14]['code_info_arr']['type'] ?>">
                            <span style="display: none" data-title="<?php echo $output['lists'][14]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][14]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][14]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][14]['code_info_arr']['pic'] ?>"  ></span>
                            <a href="" style="width:702px;height: 265px;display: block">
                                <img src="<?php echo $output['lists'][14]['code_info_arr']['pic'] ?>">
                            </a>
                        </li>
                    <?php }else{ ?>
                        <li data-id="14" class="edit-btn" id="edit-btn-14" data-code-id="" data-type="1">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img17.png"></span>
                            <a href="" style="width:702px;height: 265px;display: block">
                                <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img17.png">
                            </a>
                        </li>
                    <?php } ?>
                    <!---------------------------------------------------------->
                    ...
                    <?php if(in_array(15,$output['var_name_arr'])){  ?>
                        <li class="edit-btn" id="edit-btn-<?php echo $output['lists'][15]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][15]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][15]['code_id'] ?>" data-type="<?php echo $output['lists'][15]['code_info_arr']['type'] ?>">
                            <span style="display: none" data-title="<?php echo $output['lists'][15]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][15]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][15]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][15]['code_info_arr']['pic'] ?>"  ></span>
                            <a href="" style="width:460px;height: 265px;display: block">
                                <img src="<?php echo $output['lists'][15]['code_info_arr']['pic'] ?>">
                            </a>
                        </li>
                    <?php }else{ ?>
                        <li data-id="15" class="edit-btn" id="edit-btn-15" data-code-id="" data-type="1">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img18.png"></span>
                            <a href="" style="width:460px;height: 265px;display: block">
                                <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/home_index/img18.png">
                            </a>
                        </li>
                    <?php } ?>
                    <!---------------------------------------------------------->
