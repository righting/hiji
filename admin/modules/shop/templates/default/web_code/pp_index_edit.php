...
<link href="/shop/templates/default/css/brand/cool.css" rel="stylesheet" type="text/css">
<style>
    .edit-btn{
        color: #FFF;
                    ...
                    <li>
                        <?php if(in_array(1,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][1]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][1]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][1]['code_id'] ?>" data-type="<?php echo $output['lists'][1]['code_info_arr']['type'] ?>" class="edit-btn">
                                <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo $output['lists'][1]['code_info_arr']['pic'] ?>" data-json='<?php echo $output['lists'][1]['code_info_arr']['brand_info_json']; ?>'>
                                </span>编辑
                        ...
                        <?php }else{ ?>
                            <a href="javascript:;" id="edit-btn-1" data-id="1" data-code-id="" data-type="2" class="edit-btn">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''>
                            </span>编辑
                                <div class="big-img"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/big1.png" width="285" height="390"></div>
                                <div class="big-sign"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/sign1.png" width="84" height="42"></div>
                                <div class="big-text">品牌名称</div>
                            </a>
                        <?php } ?>
                    </li>
                    ...
                    <li>
                        <?php if(in_array(2,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][2]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][2]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][2]['code_id'] ?>" data-type="<?php echo $output['lists'][2]['code_info_arr']['type'] ?>" class="edit-btn">
                                ...
                                <div class="big-img" style="display: block;width: 585px;height: 390px"><img src="<?php echo $pic_info['pic'] ?>" width="585" height="390"></div>
                                    <?php } ?>
                                <?php } ?>
                            </a>
                        <?php }else{ ?>
                            ...
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''>
                                ...
                                <div class="big-img"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/big2.png" width="585" height="390"></div>
                                <div class="big-sign"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/sign2.png" width="84" height="42"></div>
                                <div class="big-text">品牌名称</div>
                            </a>
                        <?php } ?>
                    </li>
                    ...
                    <li>
                        <?php if(in_array(3,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][3]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][3]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][3]['code_id'] ?>" data-type="<?php echo $output['lists'][3]['code_info_arr']['type'] ?>" class="edit-btn">
                                <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo $output['lists'][3]['code_info_arr']['pic'] ?>" data-json='<?php echo $output['lists'][3]['code_info_arr']['brand_info_json']; ?>'>
                                </span>编辑
                        ...
                        <?php }else{ ?>
                            <a href="javascript:;" id="edit-btn-3" data-id="3" data-code-id="" data-type="2" class="edit-btn">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''>
                            </span>编辑
                                <div class="big-img"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/big3.png" width="285" height="390"></div>
                                <div class="big-sign"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/sign3.png" width="84" height="42"></div>
                                <div class="big-text">品牌名称</div>
                            </a>
                        <?php } ?>
                    </li>
                    ...
                    <li>
                        <?php if(in_array(4,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][4]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][4]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][4]['code_id'] ?>" data-type="<?php echo $output['lists'][4]['code_info_arr']['type'] ?>" class="edit-btn">
                                <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json='<?php echo $output['lists'][4]['pic_list_json']; ?>'>
                            </span>编辑

                                <?php if(!empty($output['lists'][4]['code_info_arr']['pic_arr'])){ ?>
                                <?php foreach ($output['lists'][4]['code_info_arr']['pic_arr'] as $pic_info){ ?>
                            <div class="big-img"><img src="<?php echo $pic_info['pic'] ?>" width="590" height="390"></div>
                                    <?php } ?>
                                <?php } ?>
                        ...
                        <?php }else{ ?>
                            ...
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''>
                                ...
                                <div class="big-img"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/big4.png" width="590" height="390"></div>
                                <div class="big-sign"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/sign1.png" width="84" height="42"></div>
                                <div class="big-text">品牌名称</div>
                            </a>
                        <?php } ?>
                    ...
                    <li>
                        <?php if(in_array(5,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][5]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][5]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][5]['code_id'] ?>" data-type="<?php echo $output['lists'][5]['code_info_arr']['type'] ?>" class="edit-btn">
                                <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json='<?php echo $output['lists'][5]['pic_list_json']; ?>'>
                            </span>编辑
                        ...
                        <?php }else{ ?>
                            ...
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''>
                                ...
                                <div class="big-img"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/big5.png" width="590" height="390"></div>
                                <div class="big-sign"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/sign3.png" width="84" height="42"></div>
                                <div class="big-text">品牌名称</div>
                            </a>
                        <?php } ?>
                ...
                <ul>
                    <li>
                        <?php if(in_array(6,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][6]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][6]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][6]['code_id'] ?>" data-type="3" class="edit-btn">
                        ...
                        <?php }else{ ?>
                            ...
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''>
                                ...
                                <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/never1.png" width="375" height="275">
                            </a>
                        <?php } ?>
                    </li>
                    <li>
                        <?php if(in_array(7,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][7]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][7]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][7]['code_id'] ?>" data-type="3" class="edit-btn">
                        ...
                        <?php }else{ ?>
                            <a href="javascript:;" id="edit-btn-7" data-id="7" data-code-id="" data-type="3" class="edit-btn">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''>
                            </span>编辑
                                <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/never2.png" width="375" height="275">
                            </a>
                        <?php } ?>
                    </li>
                    ...
                    <li>
                        <?php if(in_array(8,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][8]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][8]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][8]['code_id'] ?>" data-type="3" class="edit-btn">
                                <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json='<?php echo $output['lists'][8]['pic_list_json']; ?>'>
                            </span>编辑
                        ...
                        <?php }else{ ?>
                            <a href="javascript:;" id="edit-btn-8" data-id="8" data-code-id="" data-type="3" class="edit-btn">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''>
                            </span>编辑
                                <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/never3.png" width="375" height="580">
                            </a>
                        <?php } ?>
                    </li>
                    ...
                    <li>
                        <?php if(in_array(9,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][9]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][9]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][9]['code_id'] ?>" data-type="<?php echo $output['lists'][9]['code_info_arr']['type'] ?>" class="edit-btn">
                                <span style="display: none" data-title="<?php echo $output['lists'][9]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][9]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][9]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][9]['code_info_arr']['pic'] ?>">
                            </span>编辑
                        ...
                        <?php }else{ ?>
                            ...
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/brand/never4.png">
                            </span>编辑
                                <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/never4.png" width="780" height="275">
                            </a>
                        <?php } ?>
                    </li>
                    ...
                    <li>
                        <?php if(in_array(10,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][10]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][10]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][10]['code_id'] ?>" data-type="<?php echo $output['lists'][10]['code_info_arr']['type'] ?>" class="edit-btn">
                                <span style="display: none" data-title="<?php echo $output['lists'][10]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][10]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][10]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][10]['code_info_arr']['pic'] ?>">
                            </span>编辑
                        ...
                        <?php }else{ ?>
                            ...
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/brand/never5.png">
                            </span>编辑
                                <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/never5.png" width="375" height="275">
                            </a>
                        <?php } ?>
                    </li>
                    ...
                    <li>
                        <?php if(in_array(11,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][11]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][11]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][11]['code_id'] ?>" data-type="<?php echo $output['lists'][11]['code_info_arr']['type'] ?>" class="edit-btn">
                                <span style="display: none" data-title="<?php echo $output['lists'][11]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][11]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][11]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][11]['code_info_arr']['pic'] ?>">
                            </span>编辑
                        ...
                        <?php }else{ ?>
                            ...
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/brand/never6.png">
                            </span>编辑
                                <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/never6.png" width="780" height="275">
                            </a>
                        <?php } ?>
                    </li>
                    ...
                    <li>
                        <?php if(in_array(12,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][12]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][12]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][12]['code_id'] ?>" data-type="<?php echo $output['lists'][12]['code_info_arr']['type'] ?>" class="edit-btn">
                                <span style="display: none" data-title="<?php echo $output['lists'][12]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][12]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][12]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][12]['code_info_arr']['pic'] ?>">
                            </span>编辑
                        ...
                        <?php }else{ ?>
                            ...
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/brand/never7.png">
                            </span>编辑
                                <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/never7.png" width="575" height="275">
                            </a>
                        <?php } ?>
                    </li>
                    ...
                    <li>
                        <?php if(in_array(13,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][13]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][13]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][13]['code_id'] ?>" data-type="<?php echo $output['lists'][13]['code_info_arr']['type'] ?>" class="edit-btn">
                                <span style="display: none" data-title="<?php echo $output['lists'][13]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][13]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][13]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][13]['code_info_arr']['pic'] ?>">
                            </span>编辑
                        ...
                        <?php }else{ ?>
                            ...
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/brand/never8.png">
                            </span>编辑
                                <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/never8.png" width="575" height="275">
                            </a>
                        <?php } ?>
                    </li>
                    ...
                    <li>
                        <?php if(in_array(14,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][14]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][14]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][14]['code_id'] ?>" data-type="<?php echo $output['lists'][14]['code_info_arr']['type'] ?>" class="edit-btn">
                                <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json='<?php echo $output['lists'][14]['pic_list_json']; ?>'>
                            </span>编辑
                        ...
                        <?php }else{ ?>
                            ...
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''>
                                ...
                                <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/never9.png" width="375" height="580">
                            </a>
                        <?php } ?>
                    </li>
                    ...
                    <li>
                        <?php if(in_array(15,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][15]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][15]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][15]['code_id'] ?>" data-type="<?php echo $output['lists'][15]['code_info_arr']['type'] ?>" class="edit-btn">
                                <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json='<?php echo $output['lists'][15]['pic_list_json']; ?>'>
                            </span>编辑
                        ...
                        <?php }else{ ?>
                            ...
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''>
                                ...
                                <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/never10.png" width="375" height="275">
                            </a>
                        <?php } ?>
                    </li>
                    ...
                    <li>
                        ...
                        <?php }else{ ?>
                            <a href="javascript:;" id="edit-btn-16" data-id="16" data-code-id="" data-type="3" class="edit-btn">
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="" data-json=''>
                            </span>编辑
                                <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/never11.png" width="375" height="275">
                            </a>
                        <?php } ?>
                    </li>
                    ...
                    <li>
                        <?php if(in_array(17,$output['var_name_arr'])){  ?>
                            <a href="javascript:;" id="edit-btn-<?php echo $output['lists'][17]['code_info_arr']['id'] ?>" data-id="<?php echo $output['lists'][17]['code_info_arr']['id'] ?>" data-code-id="<?php echo $output['lists'][17]['code_id'] ?>" data-type="<?php echo $output['lists'][17]['code_info_arr']['type'] ?>" class="edit-btn">
                                <span style="display: none" data-title="<?php echo $output['lists'][17]['code_info_arr']['title'] ?>" data-f-title="<?php echo $output['lists'][17]['code_info_arr']['f_title'] ?>" data-url="<?php echo $output['lists'][17]['code_info_arr']['url'] ?>" data-pic="<?php echo $output['lists'][17]['code_info_arr']['pic'] ?>">
                            </span>编辑
                        ...
                        <?php }else{ ?>
                            ...
                            <span style="display: none" data-title="" data-f-title="" data-url="" data-pic="<?php echo SHOP_TEMPLATES_URL;?>/images/brand/never12.png">
                            </span>编辑
                                <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/brand/never12.png" width="780" height="275">
                            </a>
                        <?php } ?>
                    </li>
