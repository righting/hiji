...
class accountControl extends SystemControl{
    private $links = array(
//        array('url'=>'controller=account&action=qq','lang'=>'qqSettings'),
//        array('url'=>'controller=account&action=sina','lang'=>'sinaSettings'),
//        array('url'=>'controller=account&action=sms','text'=>'手机短信'),
//        array('url'=>'controller=account&action=wx','text'=>'微信登录'),
//		array('url'=>'controller=account&action=uc','text'=>'UC互联')
    );
