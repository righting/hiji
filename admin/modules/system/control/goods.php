        ...
        if (chksubmit()){
            ...
            $result = Model('goods')->editGoodsById($data, $_POST['goodsid']);
                 ...
                 if ($result){
                    $url = array(
                        array(
                            'url'=>'index.php?controller=goods&action=add&gid='.$_POST['goodsid'].'',
                            'msg'=>'继续',
                        ),
                        array(
                            'url'=>'index.php?controller=goods',
                            'msg'=>'返回',
                        )
                    );
