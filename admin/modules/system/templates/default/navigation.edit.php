...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?controller=navigation&action=navigation" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <input type="radio" <?php if($output['navigation_array']['nav_modue'] == '0'){ ?>checked="checked"<?php } ?> value="0" name="nav_modue" id="nav_modue0">
                <label for="nav_modue0"><?php echo $lang['navigation_index_modue_a'];?></label>
                <input type="radio" <?php if($output['navigation_array']['nav_modue'] == '1'){ ?>checked="checked"<?php } ?> value="1" name="nav_modue" id="nav_modue1">
                <label for="nav_modue1"><?php echo $lang['navigation_index_modue_b'];?></label>
                <input type="radio" <?php if($output['navigation_array']['nav_modue'] == '2'){ ?>checked="checked"<?php } ?> value="2" name="nav_modue" id="nav_modue2">
                <label for="nav_modue2"><?php echo $lang['navigation_index_modue_c'];?> </label>
                <input type="radio" <?php if($output['navigation_array']['nav_modue'] == '3'){ ?>checked="checked"<?php } ?> value="3" name="nav_modue" id="nav_modue3">
                <label for="nav_modue3"><?php echo $lang['navigation_index_modue_d'];?></label>
                <input type="radio" <?php if($output['navigation_array']['nav_modue'] == '4'){ ?>checked="checked"<?php } ?> value="4" name="nav_modue" id="nav_modue4">
                <label for="nav_modue4"><?php echo $lang['navigation_index_modue_e'];?></label>
                <input type="radio" <?php if($output['navigation_array']['nav_modue'] == '5'){ ?>checked="checked"<?php } ?> value="5" name="nav_modue" id="nav_modue5">
                <label for="nav_modue5"><?php echo $lang['navigation_index_modue_f'];?> </label>
                <input type="radio" <?php if($output['navigation_array']['nav_modue'] == '6'){ ?>checked="checked"<?php } ?> value="6" name="nav_modue" id="nav_modue6">
                <label for="nav_modue6"><?php echo $lang['navigation_index_modue_g'];?></label>
                <input type="radio" <?php if($output['navigation_array']['nav_modue'] == '7'){ ?>checked="checked"<?php } ?> value="7" name="nav_modue" id="nav_modue7">
                <label for="nav_modue7"><?php echo $lang['navigation_index_modue_h'];?></label>
                <p class="notic"></p>
            </dd>
        </dl>
                ...
                <select name="nav_pid" id="nav_pid">
                    ...
                    <?php if(!empty($output['navigation_type_list']) && is_array($output['navigation_type_list'])){ ?>
                        <?php foreach($output['navigation_type_list'] as $k => $v){ ?>
                            <option <?php if(isset($output['navigation_array']['nav_pid']) && $output['navigation_array']['nav_pid'] == $v['nav_id']){ ?>selected='selected'<?php } ?> value="<?php echo $v['nav_id'];?>"><?php echo $v['nav_title'];?></option>
                        <?php } ?>
                    <?php } ?>
                </select>
                <span class="err"></span>
