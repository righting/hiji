...
<div class="page">
  ...
  <form id="page_form" method="post" name="pageForm" enctype="multipart/form-data">
    <input type="hidden" name="video_id" value="<?php echo $output['page_array']['video_id'];?>" />
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $output['page_array']['video_title'];?>" name="page_title" id="page_title" class="input-txt">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <input type="text" value="<?php echo $output['page_array']['video_sort'];?>" name="sort" id="sort" class="input-txt">
                <span class="err"></span>
                <p class="notic"></p>
            </dd>
        </dl>
