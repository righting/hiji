...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?controller=area&action=index" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3>地区设置 - 新增</h3>
        <h5>地区新增与编辑</h5>
      </div>
  ...
  <form id="form" method="post" action="index.php?controller=area&action=save&area_id=<?php echo $_GET['area_id']?>">
