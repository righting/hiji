...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?controller=video_class&action=video_class" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="video_class_form" method="post">
...
$(function(){$("#submitBtn").click(function(){
    if($("#video_class_form").valid()){
     $("#video_class_form").submit();
	}
	});
});
//
$(document).ready(function(){
	$('#video_class_form').validate({
        ...
        rules : {
            ac_name : {
                required : true,
                remote   : {
                url :'index.php?controller=video_class&action=ajax&branch=check_class_name',
                type:'get',
                data:{
                    ac_name : function(){
                        return $('#ac_name').val();
