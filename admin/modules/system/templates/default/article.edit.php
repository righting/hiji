...
<div class="page">
  ...
  <form id="article_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <input type="hidden" value="<?php echo $output['article_array']['article_image']?>" name="articleImage" id="articleImage"/>
...
function add_uploadedfile(file_data)
{
    ...
    $('#articleImage').val("<?php echo UPLOAD_SITE_URL.'/'.ATTACH_ARTICLE.'/';?>"+file_data.file_name);
}
