...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?controller=help&action=help" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['help_index_manage'];?> - <?php echo $lang['nc_new'];?>文章</h3>
  ...
  <form id="article_form" method="post" name="articleForm">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="articleForm"><?php echo $lang['help_add_url'];?></label>
        </dt>
        <dd class="opt">
        ...
        <dd class="opt">
          <div class="onoff">
            <select name="common" id="common">
              <option <?php if($output['page_array']['common'] == 0){ ?>selected='selected'<?php } ?> value="0">否</option>
              <option <?php if($output['page_array']['common'] == 2){ ?>selected='selected'<?php } ?> value="1">是</option>
          </select>
          </div>
          <p class="notic"></p>
        </dd>
