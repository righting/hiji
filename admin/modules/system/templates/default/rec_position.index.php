...
function copyToClipBoard(id){
    ...
    {
        ajax_form('copy_rec', '<?php echo $lang['rec_ps_code'];?>', 'index.php?controller=rec_position&action=rec_code&rec_id='+id);
    }
}
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?controller=rec_position&action=get_xml',
        colModel : [
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?controller=rec_position&action=rec_add';
    }else if (name == 'delete') { 
...
function fg_delete(id) {
	...
	$.ajax({
        type: "GET",
        dataType: "json",
        url: 'index.php?controller=rec_position&action=rec_del',
        data: "rec_id="+id,
