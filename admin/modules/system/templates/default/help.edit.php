...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?controller=article&action=article" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['help_index_manage'];?> - <?php echo $lang['nc_edit'];?>文章“<?php echo $output['article_array']['article_title'];?>”</h3>
  ...
  <form id="article_form" method="post">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="article_title"><em>*</em><?php echo $lang['help_index_title'];?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="cate_id"><em>*</em><?php echo $lang['help_add_class'];?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="article_url"><?php echo $lang['help_add_url'];?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <select name="common" id="common">
              <option <?php if($output['article_array']['common'] == 0){ ?>selected='selected'<?php } ?> value="0">否</option>
              <option <?php if($output['article_array']['common'] == 1){ ?>selected='selected'<?php } ?> value="1">是</option>
          </select>
          </div>
          <p class="notic"></p>
        </dd>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <div class="onoff">
                    <select name="isConcerns" id="isConcerns">
                        <option <?php if($output['article_array']['is_concerns'] == 0){ ?>selected='selected'<?php } ?> value="0">否</option>
                        <option <?php if($output['article_array']['is_concerns'] == 1){ ?>selected='selected'<?php } ?> value="1">是</option>
                    </select>
                </div>
                <p class="notic"></p>
            </dd>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <div class="onoff">
                    <select name="isWtsj" id="isWtsj">
                        <option <?php if($output['article_array']['is_wtsj'] == 0){ ?>selected='selected'<?php } ?> value="0">否</option>
                        <option <?php if($output['article_array']['is_wtsj'] == 1){ ?>selected='selected'<?php } ?> value="1">是</option>
                    </select>
                </div>
                <p class="notic"></p>
            </dd>
...
$(document).ready(function(){
	...
	$('#article_form').validate({
        ...
        messages : {
            ...
            article_sort  : {
                number   : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['help_add_sort_int'];?>'
            }
        }
    });
    // 图片上传
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?controller=article&action=article_pic_upload&item_id=<?php echo $output['article_array']['article_id'];?>',
