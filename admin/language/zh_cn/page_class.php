...
$lang['article_class_index_class']		= '单页分类';
$lang['article_class_index_class_subhead']= '网站单页分类添加与管理';
$lang['article_class_index_name']		= '分类名称';
$lang['article_class_index_ensure_del']	= '删除该分类将会同时删除该分类的所有下级分类，您确定要删除吗';
$lang['article_class_index_help1']		= '管理员新增单页时，可选择单页分类。单页分类将在前台单页列表页显示';
$lang['article_class_index_help2']		= '默认的单页分类不可以删除';
/**
 * 新增分类
 */
