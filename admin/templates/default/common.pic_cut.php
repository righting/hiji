...
<form action="index.php?controller=common&action=pic_cut" id="form_cut" method="post">
...
$(function(){
    ...
    $('#pic_submit').click(function(){
		...
		$.post('<?php echo ADMIN_SITE_URL?>/index.php?controller=common&action=pic_cut',d,function(data){
			call_back(data);
