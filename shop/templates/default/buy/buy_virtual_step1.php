    ...
    <table class="ncc-table-style" nc_type="table_cart">
      ...
      <tbody>
        ...
        <tr class="shop-list">
          ...
          <td class="w100"><a href="<?php echo urlShop('goods','index',array('goods_id'=>$output['goods_info']['goods_id']));?>" target="_blank" class="ncc-goods-thumb"><img src="<?php echo cthumb($output['goods_info']['goods_image']);?>" alt="<?php echo $output['goods_info']['goods_name']; ?>" /></a></td>
