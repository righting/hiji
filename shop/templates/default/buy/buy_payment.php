  ...
  <div id="ncc-payment-showgoods-list" class="ncc-payment-showgoods-list">
    <dl>
      ...
      <dd data-hideshow="offline" data-cod2-type="offline">
        ...
        <div class="goods-thumb" data-cod2-store="<?php echo $value['store_id']; ?>"><span><img src="<?php echo cthumb($value['goods_image'],60);?>"></span></div>
        <?php } ?>
      </dd>
  ...
  <dl class="ncc-offpay-list" data-hideshow="offline">
    ...
    <dd>
      <ul data-cod-type="offline">
        <?php foreach((array) $output['pay_goods_list']['offline'] as $value) {?>
        <li data-cod-store="<?php echo $value['store_id']; ?>"><span title="<?php echo $value['goods_name'];?>"><img src="<?php echo cthumb($value['goods_image'],60);?>"></span></li>
        <?php } ?>
      </ul>
      <label>
