  ...
  <div class="ncc-receipt-info">
    ...
    <table class="ncc-table-style" nc_type="table_cart">
      ...
      <tbody>
        ...
        <tr class="shop-list">
          <td class="w10"></td>
          <td class="w100"><a href="<?php echo urlShop('goods','index',array('goods_id'=>$output['goods_info']['goods_id']));?>" target="_blank" class="ncc-goods-thumb"><img src="<?php echo cthumb($output['goods_info']['goods_image'],60);?>" alt="<?php echo $output['goods_info']['goods_name']; ?>" /></a></td>
      ...
      <tfoot>
        <tr>
          <td colspan="20"><a href="index.php?controller=buy_virtual&action=buy_step1&goods_id=<?php echo $_POST['goods_id'];?>&quantity=<?php echo $_POST['quantity'];?>" class="ncc-prev-btn"><i class="icon-angle-left"></i>返回上一步</a><div class="ncc-all-account">订单总金额：<em id="orderTotal"><?php echo $output['goods_info']['goods_total']; ?></em>元</div><a id="submitOrder" href="javascript:void(0)" class="ncc-next-submit ok">提交订单</a></td>
        </tr>
      </tfoot>
    </table>
  </div>
