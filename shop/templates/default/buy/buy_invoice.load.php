...
<ul>
  ...
  <div id="add_inv_box" style="display:none">
    <form method="POST" id="inv_form" action="index.php">
      ...
      <input type="hidden" value="add_inv" name="action">
...
function delInv(id){
    $('#invoice_list').load(SITEURL+'/index.php?controller=buy&action=load_inv&vat_hash<?php echo $_GET['vat_hash'];?>&del_id='+id);
}
$(function(){
	$('#vregion').nc_region();
