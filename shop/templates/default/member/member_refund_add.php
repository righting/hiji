  ...
  <div class="ncm-flow-container">
    <div class="title">
      ...
      <div class="refund-type-box">
        <div class="refund-type-text" data-value="1">仅退款（补单）</div>
        <i></i>
        <ul class="refund-type-option">
            <li data-option="1" class="seleced">仅退款（补单）</li>
            <li data-option="2">退货退款（补单）</li>
            <li data-option="3">仅退款（不补单）</li>
            <li data-option="4">退货退款（不补单）</li>
        </ul>
      </div>
    </div>
    <div class="alert">
      ...
      <div id="saleRefund" show_id="1">
          ...
          <div class="ncm-default-form">
              <form id="post_form1" enctype="multipart/form-data" method="post"
                    action="index.php?controller=member_refund&action=add_refund&order_id=<?php echo $output['order']['order_id']; ?>&goods_id=<?php echo $output['goods']['rec_id']; ?>">
                  ...
                  <dl>
                      ...
                      <dd>
                          <input type="text" class="text w50" name="refund_amount"
                                 value="<?php echo $output['goods']['goods_pay_price']; ?>"/><em class="add-on"><i
                                      class="icon-renminbi"></i></em>（最多 <strong class="green"
                                                                                 title="可退金额由系统根据订单商品实际成交额和已退款金额自动计算得出"><?php echo $output['goods']['goods_pay_price']; ?></strong>
      ...
      <div id="saleRefundReturn" show_id="2" style="display: none;">
          ...
          <div class=" ncm-default-form">
              <div id="warning"></div>
              <form id="post_form2" method="post" enctype="multipart/form-data"
                    action="index.php?controller=member_refund&action=add_refund&order_id=<?php echo $output['order']['order_id']; ?>&goods_id=<?php echo $output['goods']['rec_id']; ?>">
                  <input type="hidden" name="form_submit" value="ok"/>
                  ...
                  <dl>
                      ...
                      <dd>
                          ...
                          <em class="add-on"><i class="icon-renminbi"></i></em> （最多 <strong class="green"
                                                                                            title="可退金额由系统根据订单商品实际成交额和已退款金额自动计算得出。"><?php echo $output['goods']['goods_pay_price']; ?></strong>
                          元） <span class="error"></span>
                          <p class="hint"><?php echo '退款金额不能超过可退金额。'; ?></p>
                      </dd>
                  ...
                  <dl>
                      ...
                      <dd>
                          <input type="text" class="text w50" name="goods_num"
      ...
      <div id="saleRefund_no" style="display: none;" show_id="3">
          <div class="ncm-flow-step">
              <dl class="step-first current">
                  <dt>买家申请退款</dt>
                  <dd class="bg"></dd>
      ...
      <div id="saleRefundReturn_no" show_id="4" style="display: none;">
          <div class="ncm-flow-step">
              <dl class="step-first current">
                  <dt>买家申请退货</dt>
                  <dd class="bg"></dd>
          ...
          <div class=" ncm-default-form">
              ...
              <form id="post_form2" method="post" enctype="multipart/form-data"
                    action="index.php?controller=member_refund&action=add_refund&order_id=<?php echo $output['order']['order_id']; ?>&goods_id=<?php echo $output['goods']['rec_id']; ?>">
                  <input type="hidden" name="form_submit" value="ok"/>
                  <input type="hidden" name="refund_type" value="4"/>
                  <h3>请填写退货退款申请</h3>
                  <dl>
                      <dt><i class="required">*</i>退货退款原因：</dt>
                      <dd>
