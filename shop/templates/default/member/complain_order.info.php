...
<div class="ncm-flow-item">
      ...
      <dl>
        <dt>
          <div class="ncm-goods-thumb-mini"><a target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=> $val['goods_id'])); ?>">
            <img src="<?php echo cthumb($val['goods_image'],60); ?>" onMouseOver="toolTip('<img src=<?php echo cthumb($val['goods_image'],240); ?>>')" onMouseOut="toolTip()" /></a></div>
        </dt>
  ...
  <div class="item-order">
    ...
    <dl class="line">
      ...
      <dd> <a href="<?php echo SHOP_SITE_URL;?>/index.php?controller=member_order&action=show_order&order_id=<?php echo $output['order']['order_id'];?>"  target="_blank"> <?php echo $output['order']['order_sn'];?> </a> <a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
      ...
      <dl>
        <dt>物流单号：</dt>
        <dd><a target="_blank" href="index.php?controller=member_order&action=search_deliver&order_id=<?php echo $output['order']['order_id']; ?>"><?php echo $output['order']['shipping_code'];?></a>
