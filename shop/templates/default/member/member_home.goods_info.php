  ...
  <div class="outline">
    ...
    <div class="ncm-favorites-goods">
      <ul id="favoritesGoodsList" class="jcarousel-skin-tango">
        ...
        <li>
          <div class="ncm-goods-thumb-120"><a href="<?php echo urlShop('goods','index',array('goods_id'=>$favorites['goods_id']));?>" target="_blank"><img alt="" src="<?php echo cthumb($favorites['goods_image'], 240);?>"></a>
      ...
      <div class="more"><a target="_blank" href="index.php?controller=member_favorite_goods&action=fglist">查看收藏的所有商品</a></div>
    </div>
    <?php } else { ?>
    <dl class="null-tip">
      <dt></dt>
...
<div id="favoritesStore" class="normal">
  <div class="outline">
    ...
    <div class="ncm-favorites-store">
      ...
      <div class="more"><a target="_blank" href="index.php?controller=member_favorite_store&action=fslist">查看收藏的所有店铺</a></div>
    </div>
    <?php } else { ?>
    <dl class="null-tip">
      <dt></dt>
