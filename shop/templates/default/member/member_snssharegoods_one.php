...
<div class="dialog-share">
  <form method="post" action="index.php?controller=member_snsindex&action=sharegoods" id="sharegoods_form">
    ...
    <div class="share-content">
      ...
      <div class="share-goods">
        <div class="goods-thumb"><a target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=>$output['goods_info']['goods_id']));?>"> <img title="<?php echo $output['goods_info']['goods_name']; ?>" src="<?php echo cthumb($output['goods_info']['goods_image'],240);?>" /></a></div>
...
$(function(){
	...
	$("[nc_type='bindbtn']").bind('click',function(){
	    ...
	    if(isbind == '1'){//已经绑定
		    ...
		    window.open(MEMBER_SITE_URL + '/api.php?controller=sharebind&type='+data_str.apikey);
		}
	});
