...
<div class="essential">
  <div class="essential-nav">
    <ul id="listpj" class="tab">
      <li class="active"><a href="index.php?controller=<?php echo $output['pj_act'];?>&action=list">交易评价/晒单</a></li>
    </ul>
  </div>
  <form id="goodsevalform" method="get" class="tc">
    <input type="hidden" name="controller" value="<?php echo $output['pj_act'];?>"/>
