<link href="<?php echo SHOP_TEMPLATES_URL;?>/css/new_member_home.css" rel="stylesheet" type="text/css">
<link href="<?php echo SHOP_RESOURCE_SITE_URL;?>/layer/theme/default/layer.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" href="<?php echo SHOP_TEMPLATES_URL;?>/css/simple-calendar.css" />
<link rel="stylesheet" href="<?php echo SHOP_TEMPLATES_URL;?>/css/newaddition.css" />
...
<div class="homepage">
    ...
    <div class="homepage-details">
        ...
        <div class="homepage-details-a">
            ...
            <div class="homepage-details-a1" style="width: 966px;height: auto;">
                <div class="addition-left">
                    ...
                    <div class="addition">
                        <div class="homepage-bar"  style="width: 40%;">
                        </div>
                    </div>
                    <div class="addition-zi">
                        <?php if ($output['member_info']['is_no_bind']==1) {?>
                            <?php if ($output['member_info']['grade_up']) {?>
                                <div class="homepage-zi1">
                                    &nbsp;还差<span>2112</span>HS升值为至尊会员
                                </div>
                    ...
                    <div class="addition-a">
                        <div style="float: left">
                            <div class="homepage-wanzheng">
                                ...
                                <div class="homepage-wanzheng-b">
                                    <span>40%</span><a href="/member/index.php?controller=member_information&action=member"><span class="homepage-wanzheng-b1">去完善></span></a>
                                </div>
                            </div>
                            <div class="homepage-wanzheng">
                                ...
                                <?php if ($output['member_info']['security_level'] <= 1) { ?>
                                    ...
                                    <div class="homepage-wanzheng-b">
                                        <span>低</span><a href="/member/index.php?controller=member_security&action=index"><span class="homepage-wanzheng-b1">去提升></span></a>
                                    </div>
                                <?php } elseif ($output['member_info']['security_level'] == 2) { ?>
                                    ...
                                    <div class="homepage-wanzheng-b">
                                        <span>中</span><a href="/member/index.php?controller=member_security&action=index"><span class="homepage-wanzheng-b1">去提升></span></a>
                                    </div>
                                <?php } else { ?>
                                    <div class="homepage-gun-a">
                        ...
                        <div style="float: left;margin-left: 10px">
                            <div class="homepage-dianzi" style="margin-top: 5px">
                                <span>我的电子会员卡:</span>
                                <a href="<?php echo urlMember('help', 'member_card',array('member_id'=>hj_encrypt($_SESSION['member_id']))); ?>"><i></i></a>
                            </div>
                ...
                <div class="addition-xian"></div>

                <div class="addition-b">

                </div>
                <div class="addition-c">
                    <p>平台当前分红期数 : <span class="addition-c1">第<?php echo $output['stagesInfo']['id']?>期</span></p>
                    <p>本期分红周数 : <span class="addition-c1">第<?php echo $output['stagesInfo']['week']?>周</span></p>
                    <p>本周天数 :
                        <span class="addition-c1">第<?php echo $output['stagesInfo']['days']?>天</span>
                        <?php if($output['isSignIn']==1){ ?>
                        <a href="javascript:;"><span class="attendance" onclick="sign()">签到</span></a>
                    <?php }else{ ?>
                            <a href="javascript:;"><span class="attendance">已签</span></a>
                    <?php }?>
                    </p>
                    <p>当期剩余天数 : <span class="addition-c1"><?php echo intval((strtotime($output['stagesInfo']['end_time'])-time())/86400)+1?>天</span></p>

                    <p style="margin-top: 20px"><span style="color: #0d6cae">当期开始时间</span> : <?php echo date('Y-m-d',strtotime($output['stagesInfo']['start_time']))?></p>
                    <p><span style="color: #ae4c47">当期结束时间</span> : <?php echo date('Y-m-d',strtotime($output['stagesInfo']['end_time']))?></p>
                </div>
...
<script src="/shop/templates/default/js/simple-calendar.js"></script>
<script>
    (function() {
        //日期
        var myCalendar = new SimpleCalendar('.addition-b');
        myCalendar.updateSize('217px', '217px');
