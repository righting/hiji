...
<div class="ncm-flow-layout" id="ncmComplainFlow">
  <div class="ncm-flow-container">
    ...
    <div class="ncm-default-form">
      <form action="index.php?controller=member_complain&action=complain_save" method="post" id="add_form" enctype="multipart/form-data">
        ...
        <div class="bottom">
          <label class="submit-border"><input id="submit_button" type="submit" class="submit" value="<?php echo $lang['complain_text_submit'];?>" ></label>
