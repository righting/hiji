  ...
  <div class="ncm-flow-container">
    ...
    <div id="saleRefund" show_id="1">
      ...
      <h3>我的退款申请</h3>
        ...
        <h3>商城退款审核</h3>
            <?php if($output['refund_return_info']['refund_state'] == 4){ ?>
        <dl>
            <dt><?php echo '系统提示'.$lang['nc_colon'];?></dt>
            <dd>平台已通过您的补单退款申请，请尽快补单（<span style="color:red;font-weight: bold">提交订单时选择订单为补单订单即可</span>）！</dd>
        </dl>
            <?php  } ?>
        <dl>
