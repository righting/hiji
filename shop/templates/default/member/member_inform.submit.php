...
<div class="ncm-flow-layout">
  <div id="ncmInformFlow" class="ncm-flow-container">
    ...
    <div class="ncm-default-form">
      <div id="warning"></div>
      <form id="add_form" enctype="multipart/form-data" method="post" action="index.php?controller=member_inform&action=inform_save">
        ...
        <dl>
          ...
          <dd>
            <div class="ncm-inform-item">
              <div class="ncm-goods-thumb-mini"><a href="<?php echo urlShop('goods', 'index',array('goods_id'=>$output['goods_info']['goods_id']));?>" target="_blank"><img src="<?php echo cthumb($output['goods_info']['goods_image'],60); ?>" onMouseOver="toolTip('<img src=<?php echo cthumb($output['goods_info']['goods_image'],240); ?>>')" onMouseOut="toolTip()" /></a></div>
...
function bindInformSubject(key) {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?controller=member_inform&action=get_subject_by_typeid',
        cache:false,
        data:'typeid='+type_id,
        dataType:'json',
