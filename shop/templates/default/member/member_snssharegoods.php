...
<div class="dialog-share">
  <form method="post" action="index.php?controller=member_snsindex&action=sharegoods<?php if($_GET['irefresh'] == 1){?>&irefresh=1<?php }?>" id="sharegoods_form">
    ...
    <div class="share-content">
      ...
      <ul id="mycarousel-s" class="snsgoodsimglist jcarousel-skin-tango">
        ...
        <li><a href="javascript:void(0);" value="<?php echo $v['goods_id'] ?>">
          ...
          <i class="f"></i>
          <?php }?>
          <img title="<?php echo $v['goods_name']?>" src="<?php echo cthumb($v['goods_image'], 240);?>" width="90px" height="90px"/>
    ...
    <div id="sg_seccode" class="seccode">
      ...
      <img src="" title="<?php echo $lang['wrong_checkcode_change'];?>" name="codeimage" border="0" onclick="this.src='index.php?controller=seccode&action=makecode&nchash=<?php echo $output['nchash'];?>&t=' + Math.random()"/> <span><?php echo $lang['wrong_seccode'];?></span>
