...
<div class="sns-main-all">
  <div class="tabmenu"><?php if($output['relation'] == '3'){?>
    ...
    <?php }?>
    <ul class="tab">
      <li class="active"><i></i><a href="index.php?controller=member_snshome&action=shareglist&type=share&mid=<?php echo $output['master_info']['member_id'];?>"><?php echo $lang['sns_shareofgoods'];?></a></li>
      <li class="normal"><i></i><a href="index.php?controller=member_snshome&action=shareglist&type=like&mid=<?php echo $output['master_info']['member_id'];?>"><?php echo $lang['sns_likeofgoods'];?></a></li>
    </ul>
  ...
  <div class="sharelist-g mt30">
    ...
    <ul class="nc-sns-pinterest" id="snsPinterest">
      ...
      <li id="recordone_<?php echo $v['share_id'];?>" class="item">
        ...
        <dl>
          <dt class="goodspic"><span class="thumb size233"><i></i><a href="index.php?controller=member_snshome&action=goodsinfo&mid=<?php echo $v['share_memberid'];?>&id=<?php echo $v['share_id'];?>" title="<?php echo $v['snsgoods_goodsname']?>"> <img src="<?php echo cthumb($v['snsgoods_goodsimage'],240,$v['snsgoods_storeid']);?>"/></a></span>
    ...
    <div class="sns-norecord"><i class="goods-ico pngFix"></i><span><?php echo $lang['sns_sharegoods_nothave_self_1'];?><a href="index.php?controller=member_order" target="_blank"><?php echo $lang['sns_sharegoods_nothave_self_2'];?></a><?php echo $lang['sns_sharegoods_nothave_self_3'];?><a href="index.php?controller=member_favorite_goods&action=fglist" target="_blank"><?php echo $lang['sns_sharegoods_nothave_self_4'];?></a><?php echo $lang['sns_sharegoods_nothave_self_5'];?></span></div>
    <?php }else {?>
...
$(function(){
	...
	$('#snssharegoods').click(function(){
	    ajax_form("sharegoods", '<?php echo $lang['sns_share_purchasedgoods'];?>', '<?php echo SHOP_SITE_URL.DS;?>index.php?controller=member_snsindex&action=sharegoods', 480);
	    return false;
	});
	// 追加
	$('a[nctype="add_share"]').click(function(){
	    eval( "data_str = "+$(this).attr('data-param'));
		ajax_form('add_share', '<?php echo $lang['sns_upload_treasure_buyer_show'];?>', SITEURL+'/index.php?controller=member_snshome&action=add_share&sid='+data_str.sid+'&gid='+data_str.gid, 580);
	});
	// 买家秀
