...
<div class="sns-main-all">
  ...
  <div class="shoplist-module" id="shoplist-module">
        ...
        <div class="shop-content">
          ...
          <div class="detail">
            ...
            <ul nc_type="mycarousel" class="jcarousel-skin-tango">
              ...
              <li><div class="goods-pic"><a href="<?php echo $g_v['goodsurl'];?>" target="_blank"><img alt="<?php echo $g_v['goods_name'];?>" src="<?php echo cthumb($g_v['goods_image'], 240);?>"/></a></div></li>
              <?php }?>
            </ul>
            <?php }?>
          </div>
    ...
    <?php } else{?>
    <?php if ($output['relation'] == 3){?>
    <div class="sns-norecord"><i class="store-ico pngFix"></i><span><?php echo $lang['sns_sharestore_nohave_self_1'];?><a href="index.php?controller=member_favorite_store&action=fslist" target="_blank"><?php echo $lang['sns_sharestore_nohave_self_2'];?></a><?php echo $lang['sns_sharestore_nohave_self_3'];?></span></div>
    <?php }else {?>
...
$(function(){
	...
	$('#snssharestore').click(function(){
	    ajax_form("sharestore", '<?php echo $lang['sns_sharestore'];?>', '<?php echo SHOP_SITE_URL.DS;?>index.php?controller=member_snsindex&action=sharestore', 480);
	    return false;
	});
});
</script>
