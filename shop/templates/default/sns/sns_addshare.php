...
$(function(){
	...
	$('span[nctype="drop_image"]').click(function(){
		...
		$.getJSON('index.php?controller=member_snshome&action=del_sharepic', {apid:data_str.apid}, function(data){
			if(data.type == 'false'){
...
function ajaxFileUpload(id){
	...
	$.ajaxFileUpload
	({
		url:SITEURL + '/index.php?controller=member_snshome&action=image_upload',
		secureuri:false,
		fileElementId:id,
		dataType: 'json',
