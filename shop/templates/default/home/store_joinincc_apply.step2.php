...
<div id="apply_credentials_info" class="apply-credentials-info">
  ...
  <form id="form_credentials_info" action="index.php?controller=store_joinincc&action=step3" method="post" enctype="multipart/form-data" >
    <div id="div_settlement">
      <table border="0" cellpadding="0" cellspacing="0" class="all">
        <thead>
          <tr>
            <th colspan="20">结算（银行）账号信息</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <th class="w150"><i>*</i>银行开户行：</th>
