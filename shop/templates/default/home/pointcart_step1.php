...
<div class="wrapper pr">
  ...
  <div class="ncc-main">
    ...
    <form method="post" id="porder_form" name="porder_form" action="index.php?controller=pointcart&action=step2">
        ...
        <table class="ncc-table-style">
            ...
            <tr>
                <td colspan="20">
                    <div class="ncc-store-account">
                        <dl>
                            <dt><?php echo $lang['pointcart_step1_service_charge'];?></dt>
                            <dd class="rule"></dd>
                            <dd class="sum"><em id="eachStoreGoodsTotal_1"><?php echo number_format($output['service_charge'],2) ; ?></em>
                            </dd>
                        </dl>
                        ...
                        <dl>
                            <dt><?php echo $lang['pointcart_step1_freight'];?></dt>
                            <dd class="rule">
                            </dd>
                            <dd class="sum"><em nc_type="eachStoreFreight" id="eachStoreFreight_1"><?php echo number_format($output['freight'],2) ; ?></em>
                            </dd>
                        </dl>
                        <dl class="total">
                            <dt>合计：</dt>
                            <dd class="rule"></dd>
                            <dd class="sum"><em store_id="1" nc_type="eachStoreTotal"><?php echo number_format(round($output['service_charge']+$output['freight'],2),2) ; ?></em>元</dd>
                        </dl>
                    </div>
                </td>
            </tr>
          ...
          <tfoot>
            ...
            <tr>
              ...
              <td colspan="20"><a href="index.php?controller=pointcart" class="ncc-prev-btn"><i class="icon-angle-left"></i><?php echo $lang['pointcart_step1_return_list'];?></a>
