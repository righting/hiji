...
<div class="wrapper">
    <div class="container">
    <div class="ccy-ht-brand2"><img class="detailImg" src="<?php echo $output['brand_int']['brand_bgpic']; ?>">
        <div class="content">
            <div class="info"><img class="logo" src="<?php echo brandImage($output['brand_int']['brand_pic']); ?>">
                <div class="bname"><h1 class="title"><?php echo $output['brand_int']['brand_name']; ?></h1>
                    <p class="sold">在售商品<span><?php if (!empty($output['goods_num'])) {
                                ; ?><?php echo $output['goods_num'] ?><?php } else { ?>0<?php } ?></span>个</p></div>
            </div>
            <div class="intro"><p><?php echo $output['brand_int']['brand_introduction']; ?></p>
                <div class="focus">
<!--                    <span class="follow" id="followBtn" data-bid="--><?php //echo $output['brand_int']['brand_id']; ?><!--"><b></b>&nbsp;关注该品牌</span>-->
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="sortbar-array"> 排序方式：
                <ul class="array">
                    <li <?php if (!$_GET['key']){ ?>class="selected"<?php } ?>><a
                                href="<?php echo dropParam(array('order', 'key')); ?>" class="nobg"
                                title="<?php echo $lang['brand_index_default_sort']; ?>"><?php echo $lang['brand_index_default']; ?></a>
                    </li>
                    <li <?php if ($_GET['key'] == '1'){ ?>class="selected"<?php } ?>><a
                                ...
                                title="<?php echo ($_GET['order'] == 'desc' && $_GET['key'] == '1') ? $lang['brand_index_sold_asc'] : $lang['brand_index_sold_desc']; ?>"><?php echo $lang['brand_index_sold']; ?>
                            <i></i></a></li>
                    <li <?php if ($_GET['key'] == '2'){ ?>class="selected"<?php } ?>><a
                                ...
                                title="<?php echo ($_GET['order'] == 'desc' && $_GET['key'] == '2') ? $lang['brand_index_click_asc'] : $lang['brand_index_click_desc']; ?>"><?php echo $lang['brand_index_click'] ?>
                            <i></i></a></li>
                    <li <?php if ($_GET['key'] == '3'){ ?>class="selected"<?php } ?>><a
                                ...
                                title="<?php echo ($_GET['order'] == 'desc' && $_GET['key'] == '3') ? $lang['brand_index_price_asc'] : $lang['brand_index_price_desc']; ?>"><?php echo $lang['brand_index_price']; ?>
                            <i></i></a></li>
                </ul>
            </div>
                ...
                <ul>
                    ...
                    <?php if ($output['contract_item']) { ?>
                        <?php foreach ($output['contract_item'] as $citem_k => $citem_v) { ?>
                            <li><a mzf="sqde" href="<?php if (in_array($citem_k, $output['search_ci_arr'])) {
            ...
            <div class="sortbar-location">商品所在地：
                <div class="select-layer">
                    <div class="holder"><em nc_type="area_name">
                            <?php echo $lang['brand_index_area']; ?><!-- 所在地 --></em></div>
                    <div class="selected"><a nc_type="area_name">
                            <?php echo $lang['brand_index_area']; ?><!-- 所在地 --></a></div>
                    <i class="direction"></i>
                    <ul class="options">
