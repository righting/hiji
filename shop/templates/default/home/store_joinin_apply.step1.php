...
<div id="apply_company_info" class="apply-company-info">
  ...
  <form id="form_company_info" action="<?php echo urlShop('store_joinin','step2') ?>" method="post">
    <table border="0" cellpadding="0" cellspacing="0" class="all">
        <thead>
            <tr>
                <th colspan="2">入驻绑定</th>
            </tr>
        </thead>
        <tbody>
            <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      <thead>
        <tr>
          <th colspan="20">组织机构代码证<em>注：如三证合一，此项可不填。</em></th>
        </tr>
      </thead>
      <tbody>
        <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      <thead>
        <tr>
          <th colspan="20">一般纳税人证明<em>注：如三证合一，此项可不填。</em></th>
        </tr>
      </thead>
      <tbody>
        <tr>
