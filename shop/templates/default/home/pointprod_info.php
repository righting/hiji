<?php defined('ByCCYNet') or exit('Access Invalid!');?><link href="<?php echo SHOP_TEMPLATES_URL;?>/css/ccy-main.css" rel="stylesheet" type="text/css"><style type="text/css"></style><link href="<?php echo SHOP_TEMPLATES_URL;?>/css/home_point.css" rel="stylesheet" type="text/css">
...
function add_to_cart()
{
	...
	if(checkresult == false){
		...
		$.getJSON('<?php echo SHOP_SITE_URL; ?>/index.php?controller=pointcart&action=add&pgid=<?php echo $output['prodinfo']['pgoods_id']; ?>&quantity='+quantity, function(result){
	        if(result.done){
	        	window.location.href = '<?php echo SHOP_SITE_URL; ?>/index.php?controller=pointcart';
	        } else {
		        if(result.url){
