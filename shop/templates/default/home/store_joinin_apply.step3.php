...
<div id="apply_store_info" class="apply-store-info">
  ...
  <form id="form_store_info" action="index.php?controller=store_joinin&action=step4" method="post" >
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        ...
        <tr>
            <th class="w150"><i>*</i>登录密码：</th>
            <td><input id="password" name="password" type="password" class="w200"/>
                <span></span>
                <p class="emphasis">此密码为日后登录并管理商家中心时使用。</p></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><a href="###" id="btn_select_category" class="btn">+选择添加类目</a>
            <div id="gcategory" style="display:none;">
              ...
              <input id="btn_add_category"  style="display: none" type="button" value="确认" />
...
$(document).ready(function(){
    ...
    $('#form_store_info').validate({
        ...
        submitHandler:function(form){
            ajaxpost('form_store_info', '', '', 'onerror');
        },
        rules : {
            seller_name: {
                required: true,
