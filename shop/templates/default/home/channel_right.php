...
<div class="sale">
  <ul>
    ...
    <li>
      <div class="goods-thumb" style=" background-image: url(<?php echo cthumb($val['goods_image'], 240);?>);"><a href="<?php echo urlShop('goods','index',array('goods_id'=> $val['goods_id']));?>" target="_blank">&nbsp;</a></div>
      <dl>
