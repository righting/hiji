...
<link rel="stylesheet" type="text/css" href="<?php echo RESOURCE_SITE_URL;?>/js/jquery-ui/themes/ui-lightness/jquery.ui.css"  />
  ...
  <div class="joinin-pay">
    ...
    <form id="form_paying_money_certificate" action="index.php?controller=store_joinin&action=pay_save" method="post" enctype="multipart/form-data">
    ...
    <div class="bottom">
        ...
        <a href="javascript:closeApplyFor(<?php echo "'".$output['joinin_detail']['bind_mobile']."'"?>,<?php echo "'".$output['joinin_detail']['invite_id']."'"?>);" class="btn">取消申请</a>
    </div>
  </div>
...
<script type="text/javascript">
    ...
    function closeApplyFor(mobile,number){
        if(confirm('确定要取消申请？')){
            $.getJSON("<?php echo urlShop('store_joinin', 'closeStoreApplyFor');?>",{mobile:mobile,number:number},function(data){
                if(data.status==1){
                    window.location.href='/shop/index.php?controller=show_joinin&action=index';
                }
            })
        }
    }
