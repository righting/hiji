<?php defined('ByCCYNet') or exit('Access Invalid!');?>
  <form method="get" id="formSearch">
    <table class="search-form">
      <input type="hidden" id='controller' name='controller' value='store_vr_bill' />
      <input type="hidden" id='action' name='action' value='show_bill' />
...
<table class="ncsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td>
       	<a target="_blank" href="index.php?controller=store_vr_order&action=show_order&order_id=<?php echo $code_info['order_id'];?>"><?php echo $lang['nc_view'];?></a>
        </td>
      </tr>
      <?php } ?>
      <?php } else { ?>
...
$(function(){
    $('#ncexport').click(function(){
    	$('input[name="action"]').val('export_order');
    	$('#formSearch').submit();
    });
    $('#ncsubmit').click(function(){
    	$('input[name="action"]').val('show_bill');
    	$('#formSearch').submit();
    });
});
</script>