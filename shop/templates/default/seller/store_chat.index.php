...
<script>
    ...
    function select_seller(seller_id){
        ...
        var ajaxurl = 'index.php?controller=store_im&action=get_user_list&seller_id='+select_id;
    ...
    function store_chat_log(user_id){
        var ajaxurl = 'index.php?controller=store_im&action=get_chat_log&seller_id='+select_id;
