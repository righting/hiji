<div class="eject_con">
  ...
  <form id="category_form" method="post" target="_parent" onsubmit="ajaxpost('category_form','','','onerror')" action="index.php?controller=store_album&action=album_pic_move">
