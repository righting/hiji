...
<div class="ncsc-form-default">
  ...
  <form method="post" action="index.php?controller=store_callcenter&action=save" id="callcenter_form" onsubmit="ajaxpost('callcenter_form','','','onerror')" class="ncs-message">
