<div class="goods-gallery add-step2"> <a class="sample_demo" id="select_s" href="index.php?controller=store_album&action=pic_list&item=des" style="display:none;"><?php echo $lang['nc_submit'];?></a>
  ...
  <ul class="list">
    ...
    <li onclick="insert_editor('<?php echo cthumb($v['apic_cover'], 1280, $_SESSION['seller_session_info']['store_id']);?>');"><a href="JavaScript:void(0);"><img src="<?php echo cthumb($v['apic_cover'], 240, $_SESSION['seller_session_info']['store_id']);?>" title='<?php echo $v['apic_name']?>'/></span></a></li>
    <?php }?>
  </ul>
  <?php }else{?>
