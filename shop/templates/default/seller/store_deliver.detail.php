...
<div class="ncsc-flow-layout">
  ...
  <div class="ncsc-flow-item">
    ...
    <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="ncsc-goods-thumb-mini"><a target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=>$goods['goods_id']));?>"><img src="<?php echo cthumb($goods['goods_image'], 60); ?>" onMouseOver="toolTip('<img src=<?php echo cthumb($goods['goods_image'],'240'); ?>>')" onMouseOut="toolTip()"/></a></div>
        </dt>
...
$(function(){
	...
	$.getJSON('index.php?controller=seller_center&action=get_express&e_code=<?php echo $output['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo random(7);?>',function(data){
		if(data){
			data = var_send+data;
