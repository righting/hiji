...
<div class="ncsc-form-default">
  ...
  <form id="add_form" action="index.php?controller=store_promotion_bundling&action=bundling_quota_add" method="post">
  <?php } else {?>
  <form id="add_form" action="index.php?controller=store_promotion_bundling&action=bundling_renew" method="post">
  <?php }?>
