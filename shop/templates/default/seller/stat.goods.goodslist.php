...
<form method="get" action="index.php" target="_self" id="formSearch">
  <table class="search-form">
    ...
    <input type="hidden" name="action" value="goodslist" />
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      <td><div class="pic-thumb"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $v['goods_id']));?>" target="_blank"><img src="<?php echo cthumb($v['goods_image'], 60);?>"/></a></div></td>
...
function getStatdata(gid){
	$('#goodsinfo_div').load('index.php?controller=statistics_goods&action=goodsinfo&gid='+gid);
}
</script>