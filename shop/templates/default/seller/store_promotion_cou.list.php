...
<form method="get">
  <table class="search-form">
    <input type="hidden" name="controller" value="store_promotion_cou" />
    <input type="hidden" name="action" value="cou_list" />
    <tr>
      <td>&nbsp;</td>
      <th>状态</th>
  ...
  <tbody id="cou_list">
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle tr">
          ...
          <span>
              <a href="index.php?controller=store_promotion_cou&action=cou_edit&cou_id=<?php echo $val['id'];?>" class="btn-bluejeans">
                  <i class="icon-edit"></i>
