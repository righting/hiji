...
<div class="ncsc-form-default"> <div class="alert">
  ...
  <form action="index.php?controller=store_setting&action=store_slide" id="store_slide_form" method="post" onsubmit="ajaxpost('store_slide_form', '', '', 'onerror');return false;">
