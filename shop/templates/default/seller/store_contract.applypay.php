...
<form id="pay_form" method="post" enctype="multipart/form-data" action="index.php?controller=store_contract&action=applypay">
	<input type="hidden" id="act" name="controller" value="store_contract"/>
	<input type="hidden" id="op" name="action" value="applypay"/>
