<link type="text/css" rel="stylesheet" href="<?php echo RESOURCE_SITE_URL."/js/jquery-ui/themes/ui-lightness/jquery.ui.css";?>"/>
  ...
  <div class="essential-nav">
	...
	<div class="ncsc-form-default">
	  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?controller=store_voucher&action=<?php echo $output['type']=='add'?'templateadd':'templateedit'; ?>">
	  	<input type="hidden" id="act" name="controller" value="store_voucher"/>
	  	<?php if ($output['type'] == 'add'){?>
	  	<input type="hidden" id="op" name="action" value="templateadd"/>
	  	<?php }else {?>
	  	<input type="hidden" id="op" name="action" value="templateedit"/>
