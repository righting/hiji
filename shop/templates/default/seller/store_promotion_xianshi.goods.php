...
<ul class="goods-list">
  ...
  <li>
    <div class="goods-thumb"> <a href="<?php echo urlShop('goods', 'index', array('goods_id' => $val['goods_id']));?>" target="_blank"><img src="<?php echo cthumb($val['goods_image'], 240);?>"/></a></div>
    <dl class="goods-info">
    ...
    <a nctype="btn_add_xianshi_goods" data-storage="<?php echo $val['goods_storage'];?>" data-goods-id="<?php echo $val['goods_id'];?>" data-goods-name="<?php echo $val['goods_name'];?>" data-goods-img="<?php echo cthumb($val['goods_image'], 240);?>" data-goods-price="<?php echo $val['goods_price'];?>" href="javascript:void(0);" class="ncbtn-mini">选择商品/修改折扣价</a> </li>
  <?php } ?>
</ul>
