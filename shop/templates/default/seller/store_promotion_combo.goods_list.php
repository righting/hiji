...
<table class="ncsc-default-table">
  ...
  <tbody nctype="choose_goods_list">
    ...
    <tr class="bd-line">
      <td></td>
      <td><div class="pic-thumb"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $val['goods_id']));?>" target="black"><img src="<?php echo cthumb($val['goods_image'], 60);?>"/></a></div></td>
      <td class="tl">
        <dl class="goods-name">
