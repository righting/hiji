...
<form method="GET">
  ...
  <input type="hidden" name="action" value="activity_apply"/>
  ...
  <table class="ncsc-default-table" >
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td><div class="pic-thumb"><a href="index.php?controller=goods&goods_id=<?php echo $v['goods_id']; ?>" target="_blank"><img src="<?php echo cthumb($v['goods_image'], 60,$_SESSION['seller_session_info']['store_id']);?>"></a></div></td>
  ...
  <div class="div-goods-select">
    <form method="GET">
      <input type="hidden" name="controller" value="store_activity"/>
      <input type="hidden" name="action" value="activity_apply"/>
    ...
    <form method="POST" id="apply_form" onsubmit="ajaxpost('apply_form','','','onerror');" action="index.php?controller=store_activity&action=activity_apply_save">
      <input type="hidden" name="activity_id" value="<?php echo $_GET['activity_id'];?>"/>
      ...
      <div class="search-result">
        <ul class="goods-list">
          ...
          <li>
            <div class="goods-thumb"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $goods['goods_id']));?>" target="_blank"><img alt="<?php echo $goods['goods_name'];?>" title="<?php echo $goods['goods_name'];?>" src="<?php echo cthumb($goods['goods_image'], 240, $_SESSION['seller_session_info']['store_id']);?>"/></a></div>
            <dl class="goods-info">
              <dt>
