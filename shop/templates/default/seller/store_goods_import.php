...
<form method="post" action="index.php?controller=taobao_import&action=index" enctype="multipart/form-data" id="goods_form">
...
<!--step4-->
<?php 
$storeid= $_SESSION['seller_session_info']['store_id'];
