...
<form method="post" id="goods_gift" action="<?php echo urlShop('store_goods_online', 'save_gift');?>">
  ...
  <div class="ncsc-form-goods-gift" data-gid="<?php echo $value['goods_id'];?>">
    <div class="goods-pic"> <span><img src="<?php echo cthumb($value['goods_image'], 240);?>"/></span></div>
      ...
      <dl>
        ...
        <dd>
          <ul class="goods-gift-list" nctype="choose_goods_list">
            ...
            <li>
              <div class="pic-thumb"><span><img src="<?php echo cthumb($gift['gift_goodsimage'], '60', $_SESSION['seller_session_info']['store_id']);?>"></span></div>
              <dl class="goods_name">
