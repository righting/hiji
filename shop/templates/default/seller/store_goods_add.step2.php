        ...
        <div class="ncsc-form-goods">
                    ...
                    <div class="ncsc-brand-select">
                        <div class="selection">
                            <input name="b_name" id="b_name" value="<?php echo $output['goods']['brand_name']; ?>"
                                   type="text" class="text w180" readonly/><input type="hidden" name="b_id" id="b_id"
          ...
          <select name="plate_bottom">
                            ...
                            <div nctype="div_freight"
                                ...
                                <span id="postageName" class="transport-name"
                                      <?php if ($output['goods']['transport_title'] != '' && intval($output['goods']['transport_id'])) { ?>style="display: inline-block;"<?php } ?>><?php echo $output['goods']['transport_title']; ?></span><a
                                        ...
                                        onclick="window.open('index.php?controller=store_transport&type=select')"
                                        class="ncbtn"
                                        id="postageButton"><i
            ...
            <dl style="display: none">
                <dt><?php echo $lang['store_goods_index_goods_distribution'] . $lang['nc_colon']; ?></dt>
                <dd>
                    <ul class="ncsc-form-radio-list">
                        <li>
                            <label>
                                <input name="distribution" class="distribution-type" value="1" type="radio"
                                       <?php if (empty($output['goods']) || $output['goods']['distribution_type'] == 1) { ?>checked="checked"<?php } ?> />
                                <?php echo $lang['store_goods_index_goods_distribution_nonsupport']; ?>
                            </label>
                        </li>
                        <li>
                            <label>
                                <input name="distribution" class="distribution-type" value="2" type="radio"
                                       <?php if (!empty($output['goods']) && $output['goods']['distribution_type'] == 2) { ?>checked="checked"<?php } ?> />
                                <?php echo $lang['store_goods_index_goods_distribution_exclusive']; ?>
                            </label>
                        </li>
                        <li>
                            <label>
                                <input name="distribution" class="distribution-type" value="3" type="radio"
                                       <?php if (!empty($output['goods']) && $output['goods']['distribution_type'] == 3) { ?>checked="checked"<?php } ?> />
                                <?php echo $lang['store_goods_index_goods_distribution_whole']; ?>
                            </label>
                        </li>

                        <li <?php if(isset($output['goods']) && !in_array($output['goods']['is_distribution_goods'],[2,3])){ ?>style="display: none"<?php } ?> class="commission-rate">
                            <label>
                                <div nctype="div_freight">
                                    <label>佣金比例</label>
                                    <input id="g_freight" class="w50 text valid" type="text" value="<?php if(isset($output['goods']) && in_array($output['goods']['is_distribution_goods'],[2,3])){  echo  $output['goods']['commission_rate'];  }else{ echo 0; } ?>" name="commission_rate">
                                    <em class="add-on">%</em>
                                </div>
                            </label>
                        </li>
            ...
            <!--新品上市-->
            <dl>
                <dt><?php echo $lang['store_goods_index_goods_is_new_arrival'] . $lang['nc_colon']; ?></dt>
                <dd>
                    <ul class="ncsc-form-radio-list">

                        <li>
                            <label>
                                <input name="is_new_arrival" value="1"
                                       <?php if (!empty($output['goods']) && $output['goods']['goods_commend'] == 1) { ?>checked="checked" <?php } ?>
                                       type="radio"/>
                                <?php echo $lang['nc_yes']; ?></label>
                        </li>
                        ...
                        <li>
                            <label>
                                <input name="is_new_arrival" value="2"
                                       <?php if (empty($output['goods']) || $output['goods']['goods_commend'] == 2) { ?>checked="checked" <?php } ?>
                                       type="radio"/>
                                <?php echo $lang['nc_no']; ?></label>
                        </li>
