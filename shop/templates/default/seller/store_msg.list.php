...
<table class="ncsc-default-table">
  <thead>
    ...
    <tr>
      ...
      <td colspan="20"><label for="all">全选</label>
        ...
        <?php if ($_SESSION['seller_session_info']['seller_is_admin']) {?>
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="tl <?php if (empty($val['sm_readids']) || !in_array($_SESSION['seller_session_info']['seller_id'], $val['sm_readids'])) {?>fb dark<?php }?>"><?php echo $val['sm_content']?></td>
