...
<div class="ncsc-form-default">
    ...
    <form id="add_form" action="index.php?controller=store_promotion_xianshi&action=xianshi_save" method="post">
    <?php } else { ?>
    <form id="add_form" action="index.php?controller=store_promotion_xianshi&action=xianshi_edit_save" method="post">
