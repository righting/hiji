...
$(document).ready(function() {
    ...
    function change_seccode() {
        $('#codeimage').attr('src', 'index.php?controller=seccode&action=makecode&nchash=<?php echo $output['nchash'];?>&t=' + Math.random());
        $('#captcha').select();
    }
    ...
    $("#form_login").validate({
        ...
        rules:{
            ...
            captcha:{
                required:true,
                remote:{
                    url:"index.php?controller=seccode&action=check&nchash=<?php echo $output['nchash'];?>",
                    type:"get",
                    data:{
                        captcha:function() {
                            return $("#captcha").val();
...
<div class="ncsc-login-container">
  ...
  <form id="form_login" action="index.php?controller=seller_login&action=login" method="post" >
    ...
    <div class="input">
      ...
      <div class="code">
        <div class="arrow"></div>
        <div class="code-img"><a href="javascript:void(0)" nctype="btn_change_seccode"><img src="index.php?controller=seccode&action=makecode&nchash=<?php echo $output['nchash'];?>" name="codeimage" border="0" id="codeimage"></a></div>
  ...
  <div class="copyright">Powered by <?php echo $output['setting_config']['ccynet_version'];?> © 2007-2015 <a href="http://www.ccynet.cn//" target="_blank">ccynet.com</a> </div>
</div>
</body>
</html>
