  ...
  <table class="search-form">
    <tbody>
      <tr>
        ...
        <td class="tc w70"><a href="index.php?controller=store_promotion_bundling&action=bundling_add_goods" nctype="search_a" class="ncs-btn"><i class="icon-search"></i><?php echo $lang['nc_search'];?></a></td>
        <td class="w10"></td>
      </tr>
    </tbody>
  </table>
  <div class="search-result" style="width:739px;">
    ...
    <ul class="goods-list" nctype="bundling_goods_add_tbody" style=" width:760px;">
      ...
      <li nctype="<?php echo $val['goods_id'];?>">
        <div class="goods-thumb"><img src="<?php echo cthumb($val['goods_image'], 240, $_SESSION['seller_session_info']['store_id']);?>" nctype="<?php echo $val['goods_image'];?>" /></div>
        <dl class="goods-info">
        ...
        <div data-param="{gid:<?php echo $val['goods_id'];?>,image:'<?php echo $val['goods_image'];?>',src:'<?php echo cthumb($val['goods_image'], 60, $_SESSION['seller_session_info']['store_id']);?>',gname:'<?php echo $val['goods_name'];?>',gprice:'<?php echo $val['goods_price'];?>',gstorang:'<?php echo $val['goods_storage'];?>'}"><a href="JavaScript:void(0);" class="ncbtn-mini ncbtn-mint" onclick="bundling_goods_add($(this))"><i class="icon-plus"></i><?php echo $lang['bundling_goods_add_bundling'];?></a></div>
      </li>
      <?php }?>
    </ul>
    <?php }else{?>
