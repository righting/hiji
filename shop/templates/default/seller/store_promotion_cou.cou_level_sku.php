  ...
  <table class="search-form">
    <tbody>
      <tr>
        ...
        <td class="tc w70"><a href="index.php?controller=store_promotion_cou&action=cou_level_sku&level=<?php echo $output['level']; ?>" nctype="search_a" class="ncs-btn"><i class="icon-search"></i><?php echo $lang['nc_search'];?></a></td>
        <td class="w10"></td>
      </tr>
    </tbody>
  </table>
...
$inPageProducts[$val['goods_id']] = array(
    ...
    'imgUrl' => cthumb($val['goods_image'], 60, $_SESSION['seller_session_info']['store_id']),
);
?>
