...
<?php if ($output['order_info']) {?>
  ...
  <form id="changeform" method="post" action="index.php?controller=store_order&action=change_state&state_type=spay_price&order_id=<?php echo $output['order_info']['order_id']; ?>">
