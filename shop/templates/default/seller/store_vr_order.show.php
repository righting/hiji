  ...
  <div class="ncsc-order-contnet">
    <table class="ncsc-default-table order">
      ...
      <tbody>
        ...
        <tr>
          <td class="bdl"></td>
          <td><div class="pic-thumb"><a href="<?php echo urlShop('goods','index',array('goods_id' => $output['order_info']['goods_id']));?>" target="_blank" onMouseOver="toolTip('<img src=<?php echo cthumb($output['order_info']['goods_image'], 240);?>>')" onMouseOut="toolTip()"/><img src="<?php echo cthumb($output['order_info']['goods_image'], 60);?>"/></a></div></td>
