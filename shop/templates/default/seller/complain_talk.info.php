...
<?php } ?>
<form action="index.php?controller=store_complain&action=apply_handle" method="post" id="handle_form">
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?controller=store_complain&action=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?controller=store_complain&action=publish_complain_talk',
                cache:false,
