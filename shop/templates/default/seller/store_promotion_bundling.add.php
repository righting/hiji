...
<div class="essential">
  ...
  <div class="ncsc-form-default"> 
    ...
    <form id="add_form" method="post" action="index.php?controller=store_promotion_bundling&action=bundling_add">
      ...
      <dl>
        ...
        <dd>
          ...
          <table class="ncsc-default-table mb15">
            ...
            <tbody nctype="bundling_data"  class="bd-line tip" title="<?php echo $lang['bundling_add_goods_explain'];?>">
              ...
              <tr id="bundling_tr_<?php echo $val['goods_id']?>" class="off-shelf">
                ...
                <td class="w50"><div class="shelf-state"><div class="pic-thumb"><img src="<?php echo cthumb($output['goods_list'][$val['goods_id']]['goods_image'], 60, $_SESSION['seller_session_info']['store_id']);?>" ncname="<?php echo $output['goods_list'][$val['goods_id']]['goods_image'];?>" nctype="bundling_data_img">
                    </div></div>
                </td>
          ...
          <a id="bundling_add_goods" href="index.php?controller=store_promotion_bundling&action=bundling_add_goods" class="ncbtn ncbtn-aqua"><?php echo $lang['bundling_goods_add'];?></a>
