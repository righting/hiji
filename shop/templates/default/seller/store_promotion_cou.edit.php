...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?controller=store_promotion_cou&action=cou_edit_save" method="post">
            ...
            <tr class="off-shelf" data-product-id="<?php echo $g['goods_id']; ?>">
              <td class="w50"><input type="hidden" name="cou_sku[]" value="<?php echo $g['goods_id']; ?>" />
                <div class="shelf-state">
                  <div class="pic-thumb"> <img src="<?php echo cthumb($g['goods_image'], 60, $_SESSION['seller_session_info']['store_id']); ?>" /> </div>
                </div></td>
...
<?php } ?>
        ...
        <a id="cou-sku-choose-btn" href="index.php?controller=store_promotion_cou&action=cou_sku&cou_id=<?php echo $info['id']; ?>" class="ncbtn ncbtn-aqua">选择活动商品</a>
...
$(function() {
    ...
    var couLevelSkuChooseTriggered = function(id, url) {
        $("[data-cou-level-sku-choose-container='"+id+"']").load(
            url || 'index.php?controller=store_promotion_cou&action=cou_level_sku&level='+id,
            function() {
