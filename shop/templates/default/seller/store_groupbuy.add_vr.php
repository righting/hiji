...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?controller=store_groupbuy&action=groupbuy_save&vr=1" method="post" enctype="multipart/form-data">
    <dl>
...
<?php } ?>
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hr8"><a class="des_demo ncbtn" href="index.php?controller=store_album&action=pic_list&item=groupbuy"><i class="icon-picture"></i><?php echo $lang['store_goods_album_insert_users_photo'];?></a></p>
...
$("select[name=class]").change(function(){
    ...
    $.ajax({
        type:'GET',
        url:'index.php?controller=store_groupbuy&action=ajax_vr_class&class_id='+class_id,
...
$("select[name=city]").change(function(){
    ...
    $.ajax({
        type:'GET',
        url:'index.php?controller=store_groupbuy&action=ajax_vr_area&area_id='+area_id,
        success:function(json){
            var html = '<option value="">'+'请选择...'+'</option>';
