/* 公共JS
 * @copyright  Copyright (c) 2007-2017 ccynet Inc. (http://www.ccynet.net)
...
function weixin_login(){
    ...
    $.getScript("http://res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js", function(){
        var obj = new WxLogin({
            ...
            scope: "snsapi_login", 
            redirect_uri: MEMBER_SITE_URL+"/index.php?controller=connect_wx&action=get_info",
            state: "js",
            style: "",
            href: ""
        });
...
(function($) {
    $.show_nc_login = function(options) {
        ...
        if (connect_qq == '1'){
            add_html += '<a href="'+MEMBER_SITE_URL+'/index.php?controller=connect_qq&ref_url=js'+encodeURIComponent(ref_url)+'" title="QQ账号登录" class="qq"><i></i></a>';
        }
        if (connect_sn == '1'){
            add_html += '<a href="'+MEMBER_SITE_URL+'/index.php?controller=connect_sina&ref_url=js'+encodeURIComponent(ref_url)+'" title="新浪微博账号登录" class="sina"><i></i></a>';
        }
        if (connect_wx == '1'){
