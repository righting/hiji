...
<header class="ncsc-head-layout w">
  <div class="wrapper">
    <div class="ncsc-admin">
      ...
      <div class="ncsc-admin-function"><a style="display: none" href="<?php echo urlShop('show_store', 'index', array('store_id'=>$_SESSION['seller_session_info']['store_id']), $output['store_info']['store_domain']);?>" title="前往店铺" ><i class="icon-home"></i></a><a href="<?php echo urlSellerMember('member_security', 'auth',array('type'=>'modify_pwd'));?>" title="修改密码" target="_blank"><i class="icon-wrench"></i></a><a href="<?php echo urlShop('seller_logout', 'logout');;?>" title="安全退出"><i class="icon-signout"></i></a></div>
    </div>
