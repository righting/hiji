...
?>/css/csshover.htc);
    ...
    <link href="<?php echo SHOP_TEMPLATES_URL; ?>/css/jx/sharp.css" rel="stylesheet" type="text/css">
...
<div class="header-wrap">
    <header class="public-head-layout wrapper">
        <h1 class="site-logo-xpss"><a href="/shop/index.php?controller=jx&action=index"><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/jx/sharp_logo.png" class=""></a>
