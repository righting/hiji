...
?>/css/csshover.htc);
    ...
    <link href="<?php echo SHOP_TEMPLATES_URL; ?>/css/global/cool.css" rel="stylesheet" type="text/css">
...
<div class="header-wrap">
    <header class="public-head-layout wrapper">
        <h1 class="site-logo-xpss">
            <a href="<?php echo BASE_SITE_URL; ?>">
            <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/global/global.png" class="pngFix"></a>
