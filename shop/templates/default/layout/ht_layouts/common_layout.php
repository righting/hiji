...
<span id="fixed-box">
    <div class="w">
        <div class="wrap_nav public-head-layout">
            <div class="nav_logo">
                <a href="index.php?controller=cate&action=ht"></a>
            ...
            <form action="<?php echo SHOP_SITE_URL; ?>" method="get" class="search-form" id="top_search_form">
                <div class="nav_search">
                    ...
                    <input name="keyword" id="keyword" type="text" class="input-text" value="<?php echo $keyword; ?>"
                           ...
                           autocomplete="off"/>
                    <input type="button" id="button" class="icon button">
                </div>
            </form>
        </div>
    </div>
...
<header class="wrap_color">
    <nav class="public-nav-layout ">
        <div class="wrapper">
            <div class="all-category" style="width:200px; ">
                <?php require template('layout/ht_layouts/home_goods_class'); ?>
            </div>
            <ul class="site-menu">
                <li>
