...
<div class="header-wrap"><header class="public-head-layout wrapper"><h1 class="site-logo"><a href="<?php echo SHOP_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['site_logo']; ?>" class="pngFix"></a>
...
</h1><div class="title"><h2> <?php echo $lang['text_groupbuy'];?> </h2><?php if ($_GET['action'] == 'index' || strpos($_GET['action'], 'vr_groupbuy_') === 0) { ?><div class="city"> 地区[<a href="javascript:void(0)" id="button_show"><h3 id="show_area_name"><?php if (empty($output['city_name'])){ echo '全国';}else{ echo $output['city_name'];}?></h3><i class="arrow"></i></a>]</div><div id="list" class="list" style="display:none;"><a id="button_close" class="close" href="javascript:void(0)">&#215;</a><ul><li><a href="<?php echo urlShop('show_groupbuy', 'select_city'); ?>&back_op=<?php echo $_GET['action']; ?>&city_id=0"><?php echo $lang['text_country'];?></a></li><?php $names = $output['groupbuy_vr_cities']['name']; foreach ($output['groupbuy_vr_cities']['children'][0] as $v) { ?><li><a href="<?php echo urlShop('show_groupbuy', 'select_city'); ?>&back_op=<?php echo $_GET['action']; ?>&city_id=<?php echo $v; ?>"><?php echo $names[$v]; ?></a></li><?php } ?></ul></div><?php } ?></div><div class="head-search-layout"> <div class="head-search-bar" id="head-search-bar">
