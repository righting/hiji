...
?>/css/csshover.htc);
    ...
    <link href="<?php echo SHOP_TEMPLATES_URL; ?>/css/xp/xpss.css" rel="stylesheet" type="text/css">
    <link href="<?php echo SHOP_TEMPLATES_URL; ?>/css/xp/xpss_banner.css" rel="stylesheet" type="text/css">
    ...
    <script src="<?php echo SHOP_TEMPLATES_URL; ?>/js/xp/TY_banner1.js"></script>
...
<div class="header-wrap">
    <header class="public-head-layout wrapper">
        <h1 class="site-logo-xpss"><a href="/shop/index.php?controller=xp&action=index"><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/xp/xpss_logo.png" class=""></a>
