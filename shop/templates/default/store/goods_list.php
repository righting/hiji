  ...
  <div class="ncs-main-container">
    ...
    <div class="ncs-goodslist-bar">
      ...
      <form id="" name="searchShop" method="get" action="index.php" >
        <input type="hidden" name="controller" value="show_store" />
        <input type="hidden" name="action" value="goods_all" />
    ...
    <div class="content ncs-all-goods-list mb15">
      <ul>
        ...
        <li>
          <dl>
            <dt><a href="<?php echo urlShop('goods', 'index',array('goods_id'=>$value['goods_id']));?>" class="goods-thumb" target="_blank"><img src="<?php echo cthumb($value['goods_image'], 240);?>" alt="<?php echo $value['goods_name'];?>" /></a>
              ...
              <?php if (is_array($value['image'])) { array_splice($value['image'], 5);?>
                  ...
                  <li<?php if($i==1) {?> class="selected"<?php }?>><a href="javascript:void(0);"><img src="<?php echo cthumb($val['goods_image'], 60);?>"/></a></li>
                  <?php }?>
              <?php } else {?>
                  <li class="selected"><a href="javascript:void(0)"><img src="<?php echo cthumb($value['goods_image'], 60);?>"></a></li>
              <?php }?>
              </ul>
            </dt>
