      ...
      <ol>
        ...
        <li>
          <dl>
            ...
            <dd class="goods-pic"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $g['goods_id'])); ?>"><span class="thumb size60"><i></i><img src="<?php echo cthumb($g['goods_image'], 60); ?>"  onload="javascript:DrawImage(this,60,60);"></span></a>
              <p><span class="thumb size100"><i></i><img src="<?php echo cthumb($g['goods_image'], 240); ?>" onload="javascript:DrawImage(this,100,100);" title="<?php echo $g['goods_name']; ?>"><big></big><small></small></span></p>
            </dd>
...
<div class="ncs-sidebar-container ncs-top-bar">
  ...
  <div id="hot_sales_list" class="content">
    <ul class="ncs-mall-booth-list">
      ...
      <li>
        <div class="goods-pic"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $g['goods_id'])); ?>"><img src="<?php echo cthumb($g['goods_image'], 240); ?>"></a></div>
