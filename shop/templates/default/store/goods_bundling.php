...
<div class="ncs-goods-info-content" nctype="gbc_content">
  ...
  <div <?php if ($current) {?>style="display:none;"<?php }?> class="ncs-combo-box">
    <div class="default-goods">
      <div class="goods-thumb"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['goods_info']['goods_id']));?>" target="block"><img src="<?php echo cthumb($output['goods_info']['goods_image'], 240);?>" title="<?php echo $output['goods_info']['goods_name'];?>" alt="<?php echo $output['goods_info']['goods_name'];?>"/></a></div>
      <dl>
      ...
      <div class="combo-goods-box" nctype="combo_list">
        ...
        <ul class="F-center">
          ...
          <li <?php if ($j == 0) {?>class="combo-goods-first"<?php $j++;}?> data-id="<?php echo $key;?>">
            <div class="goods-thumb"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $combo['goods_id']));?>" target="block"><img src="<?php echo cthumb($combo['goods_image'], 240);?>" title="<?php echo $combo['goods_name'];?>" alt="<?php echo $combo['goods_name'];?>" onload="javascript:DrawImage(this,100,100);" /></a></div>
            <dl>
...
function addcombcart(goods_ids)
{
    ...
    var url = 'index.php?controller=cart&action=add_comb';
