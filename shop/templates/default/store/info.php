...
<div class="ncs-info" style="display: none">
  <div class="title">
  ...
  <div class="content">
    ...
    <div class="ccynet-ownshop">本商城自营产品</div><?php } ?>
...
$(function(){
	...
	var act = "<?php echo trim($_GET['controller']); ?>";
	var op  = "<?php echo trim($_GET['action']) != ''?trim($_GET['action']):'index'; ?>";
	$.getJSON("index.php?controller=show_store&action=ajax_flowstat_record",{store_id:store_id,goods_id:goods_id,act_param:act,op_param:op});
});
</script> 
<div class="ncs-message-bar" style="display:none" >
