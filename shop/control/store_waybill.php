...
class store_waybillControl extends BaseSellerControl{
    ...
    public function waybill_manageOp() {
        ...
        $store_extend_info = $model_store_extend->getStoreExtendInfo(array('store_id' => $_SESSION['seller_session_info']['store_id']), 'express');
        $store_express = $store_extend_info['express'];

        $express_list = $model_express->getExpressListByID($store_express);

        $store_waybill_list = $model_store_waybill->getStoreWaybillListWithWaybillInfo($_SESSION['seller_session_info']['store_id'], $store_express);
    ...
    public function waybill_bindOp() {
        ...
        $waybill_list = $model_waybill->getWaybillUsableList($express_id, $_SESSION['seller_session_info']['store_id']);
    ...
    public function waybill_set_defaultOp() {
        ...
        $result = $model_store_waybill->editStoreWaybillDefault($store_waybill_id, $_SESSION['seller_session_info']['store_id']);
    ...
    public function waybill_listOp() {
        ...
        $waybill_list = $model_waybill->getWaybillSellerList($_SESSION['seller_session_info']['store_id']);
        Tpl::output('waybill_list', $waybill_list);
    ...
    public function waybill_saveOp() {
        $model_waybill = Model('waybill');
        $result = $model_waybill->saveWaybill($_POST, $_SESSION['seller_session_info']['store_id']);
    ...
    public function waybill_editOp() {
        ...
        $waybill_info = $model_waybill->getWaybillInfoByID($_GET['waybill_id']);
        if(!$waybill_info || $waybill_info['store_id'] != $_SESSION['seller_session_info']['store_id']) {
            showMessage('运单模板不存在');
        }
        Tpl::output('waybill_info', $waybill_info);
    ...
    public function waybill_design_saveOp() {
        ...
        $result = $model_waybill->editWaybillDataByID($_POST['waybill_data'], $_POST['waybill_id'], $_SESSION['seller_session_info']['store_id']);
