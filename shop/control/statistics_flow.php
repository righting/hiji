...
class statistics_flowControl extends BaseSellerControl{
    ...
    public function storeflowOp() {
        $store_id = intval($_SESSION['seller_session_info']['store_id']);
        //确定统计分表名称
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'storeflow','menu_name'=>'店铺总流量','menu_url'=>'index.php?controller=statistics_flow&action=storeflow'),
            2=>array('menu_key'=>'goodsflow','menu_name'=>'商品流量排名','menu_url'=>'index.php?controller=statistics_flow&action=goodsflow')
        );
