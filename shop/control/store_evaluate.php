...
class store_evaluateControl extends BaseSellerControl{
    ...
    public function listOp(){
        ...
        $condition['geval_storeid'] = $_SESSION['seller_session_info']['store_id'];
    ...
    public function explain_saveOp(){
        ...
        $evaluate_info = $model_evaluate_goods->getEvaluateGoodsInfoByID($geval_id, $_SESSION['seller_session_info']['store_id']);
