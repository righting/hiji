...
class store_promotion_mansongControl extends BaseSellerControl {
    ...
    public function __construct() {
        ...
        if (intval(C('promotion_allow')) !== 1) {
            showMessage(Language::get('promotion_unavailable'),'index.php?controller=seller_center','','error');
        }
    ...
    public function mansong_listOp() {
        ...
        if (checkPlatformStore()) {
            ...
            $current_mansong_quota = $model_mansong_quota->getMansongQuotaCurrent($_SESSION['seller_session_info']['store_id']);
    ...
    public function mansong_addOp() {
        ...
        $start_time = $model_mansong->getMansongNewStartTime($_SESSION['seller_session_info']['store_id']);
    ...
    public function mansong_saveOp() {
        ...
        $start_time_limit = $model_mansong->getMansongNewStartTime($_SESSION['seller_session_info']['store_id']);
    ...
    public function mansong_detailOp() {
        ...
        $mansong_info = $model_mansong->getMansongInfoByID($mansong_id, $_SESSION['seller_session_info']['store_id']);
