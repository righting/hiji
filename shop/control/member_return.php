 ...
 *
 *
 * @copyright  Copyright (c) 2007-2012 ccynet Inc. (http://www.ccynet.cn/)
...
class member_returnControl extends BaseMemberControl {
    ...
    public function shipOp(){
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                showDialog(Language::get('nc_common_save_succ'),'index.php?controller=member_return&action=index','succ');
            } else {
