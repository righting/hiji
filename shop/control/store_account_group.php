...
class store_account_groupControl extends BaseSellerControl {
    ...
    public function group_listOp() {
        ...
        $seller_group_list = $model_seller_group->getSellerGroupList(array('store_id' => $_SESSION['seller_session_info']['store_id']));
    ...
    public function group_saveOp() {
        ...
        $seller_info['store_id'] = $_SESSION['seller_session_info']['store_id'];
        $model_seller_group = Model('seller_group');
    ...
    private function _get_goods_class_list($group_id = null) {
        ...
        if (checkPlatformStoreBindingAllGoodsClass()) {
            ...
            $bind_class = $model_store_bind_class->getStoreBindClassList(array('store_id'=>$_SESSION['seller_session_info']['store_id']),'','','*',false);
