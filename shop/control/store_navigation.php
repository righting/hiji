...
class store_navigationControl extends BaseSellerControl {
    ...
    public function navigation_listOp() {
        ...
        $navigation_list = $model_store_navigation->getStoreNavigationList(array('sn_store_id' => $_SESSION['seller_session_info']['store_id']));
    ...
    public function navigation_editOp() {
        ...
        if(empty($sn_info) || intval($sn_info['sn_store_id']) !== intval($_SESSION['seller_session_info']['store_id'])) {
           showMessage(L('wrong_argument'), urlShop('store_navigation', 'navigation_list'), '', 'error');
        }
    ...
    public function navigation_saveOp() {
        $sn_info = array(
            ...
            'sn_store_id' => $_SESSION['seller_session_info']['store_id'],
