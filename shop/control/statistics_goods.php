...
class statistics_goodsControl extends BaseSellerControl {
    ...
    public function __construct(){
        ...
        //处理搜索时间
        if (in_array($this->search_arr['action'],array('price','hotgoods'))){
    ...
    public function priceOp(){
        ...
        $field = '1';
        $pricerange = Model('store_extend')->getfby_store_id($_SESSION['seller_session_info']['store_id'],'pricerange');
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'goodslist','menu_name'=>'商品详情',   'menu_url'=>'index.php?controller=statistics_goods&action=goodslist'),
            2=>array('menu_key'=>'price','menu_name'=>'价格销量',   'menu_url'=>'index.php?controller=statistics_goods&action=price'),
            3=>array('menu_key'=>'hotgoods','menu_name'=>'热卖商品',    'menu_url'=>'index.php?controller=statistics_goods&action=hotgoods'),
        );
