...
class store_plateControl extends BaseSellerControl {
    ...
    public function plate_editOp() {
        ...
        $plate_info = Model('store_plate')->getStorePlateInfo(array('plate_id' => $plate_id, 'store_id' => $_SESSION['seller_session_info']['store_id']));
    ...
    public function drop_plateOp() {
        ...
        $return = Model('store_plate')->delStorePlate(array('plate_id' => array('in', $plateid_array), 'store_id' => $_SESSION['seller_session_info']['store_id']));
        if ($return) {
