...
function zsc_show(id){
	...
	if(zsc_class!='add'){
		...
		var url = "index.php?controller=seller_wechat&action=addkeyword_ajax&kid="+zsc_id;
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		if(count==0){
			//var url = "/biz.php?ctl=wechat&act=keyword_index&action=add";
			var url = "index.php?controller=seller_wechat&action=keyword_index&opt=add";
			...
			//var url = "/biz.php?ctl=wechat&act=keyword_index&action=update";
			var url = "index.php?controller=seller_wechat&action=keyword_index&opt=update";
			var kid = $('#zsc_iid').val();
...
function zscdel(num){
	...
	var url = "index.php?controller=seller_wechat&action=keyword_index&opt=del";
	//var url = "/biz.php?ctl=wechat&act=keyword_index&action=del";
		   ...
		   (
			   {
					...
					url:"index.php?controller=seller_wechat&action=upload_fm",
