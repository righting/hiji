                    ...
                    <?php /*if ($_SESSION['is_login']) { */?>
                        ...
                        <div class="user-info" nctype="barUserInfo" style="display:none;"><i class="arrow"></i>
                            ...
                            <dl>
                                ...
                                <dd>当前积分：<strong
                                            nctype="barMemberExp"><?php /*echo $output['member_info']['member_points']; */?>H</strong>
                                </dd>
                            </dl>
                        </div>
                    <?php /*} else { */?>
        ...
        <div class="user-entry">
            <?php if ($_SESSION['is_login'] == '1') { ?>
                <?php echo $lang['nc_hello']; ?> <span> <a
                            href="<?php echo urlShop('member', 'home'); ?>"><?php echo $output['member_info']['member_nickname']; ?></a>
            ...
            <dl>
                ...
                <dd>
                    <ul>
                        ...
                        <li><a href="<?php echo urlMember('help_store', 'help'); ?>" title="商家服务">商家服务</a></li>
