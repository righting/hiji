        ...
        <div class="business-service">
            <div class="service-detail">
                <div class="service-search">
                    <form action="<?php echo urlMember('help', 'show_list', array('ac_id' => $output['ac_id'])); ?>/member/index.php?controller=help_store&action=show_list">
                        <input type="text" name='keyword' placeholder="请用一句话描述您的问题，如：如何入驻平台？">
                        <!--<button></button>-->
                        <input type="submit" id="button" value="" class="input-submit-a">
                    </form>
                </div>
                ...
                <div class="service-answer">
                    <p class="service-a">
                        ...
                        <?php }?>
                        <?php if(!empty($output['article_list']['article_title'])){?>
                            &gt;<span><?php echo $output['article_list']['article_title'];?></span>
                        <?php }?>
                    </p>
                    ...
                    <?php if(is_array($output['article_list']) && !empty($output['article_list'])){?>
                        <?php foreach ($output['article_list'] as $ak=>$av){?>
                            <li>
                                <a href="<?php echo urlMember('help', 'show', array('article_id'=>$av['article_id']));?>">
                                    <h3><?php echo $av['article_title'];?></h3>
                                </a>
                                <span><?php echo date('Y-m-s',$av['article_time']);?><span>
                            </li>
                        <?php }?>
                    <?php }else{?>
                        <li>暂没数据解答</li>
                ...
                <?php if(is_array($output['article_list']) && empty(!$output['article_list'])){?>
                 <div class="pagination" style="clear: inherit;"><?php echo $output['show_page']; ?></div>
            <?php }?>
            </div>
        </div>
        <!-- <div class="service-main">
            <div class="problem service-layout">
                <h1 class="title"><em></em>问题列表</h1>
                <ul>
                    <?php if(is_array($output['article_list']) && !empty($output['article_list'])){?>
                        <?php foreach ($output['article_list'] as $ak=>$av){?>
                        <li style="float:none;font-size:16px;width:100%;">
                            <a href="<?php echo urlMember('help', 'show', array('article_id'=>$av['article_id']));?>">
                                <?php echo $av['article_title'];?>
                            </a>
                        </li>
                        <?php }?>
                    <?php }else{?>
...
<script>
    $(function () {
        $(".subside-mod .icon02").click(
            function () {
                $(this).parent().parent(".subside-mod").toggleClass("on")
            })
    });
</script>