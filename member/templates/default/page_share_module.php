    ...
    <div class="topbar wrapper">
        <div class="user-entry" style="font-size:12px;">
            ...
            <a href="<?php echo urlShop('member', 'home'); ?>">
                <?php echo $_SESSION['member_nickname']?></a>        <a href="<?php echo urlShop('member', 'home'); ?>"><span class="user-class"><?php echo $output['levelInfo']['level_name']?><?php }?></span></a>，欢迎来到      <a href="/" title="首页" alt="首页">海吉壹佰</a>
...
<?php
    ...
    $article=Model()->table('article')->where($where)->limit(5)->order(' rand() ')->select();
    ...
    <div class="sharemodule">
        <div class="sharemodule-left">
            ...
            <a href="/member/index.php?controller=page&action=show&page_key=share_module">
                <p <?php if($_GET['page_key']=='share_module'){echo 'class="sharemodule-bei"';}?>>视频分享</p>
            </a>
        ...
        <div class="sharemodule-right">
            <div class="sharemodule-right-a">
                <ul>
                    <li class="sharemodule-right-li1">
                        <script id="vision-age2" type="text/template">
                            <a href="javascript:void(0);" >

                                <div class="sharemodule-right-a1" data-src="<?php echo $output['videoInfo'][0]['video_url']?>">
                                    <img class="img" src="/data/upload/shop<?php echo $output['videoInfo'][0]['video_img']?>">
                                    <img src="<?php echo MEMBER_TEMPLATES_URL ?>/images/video-sarch.png" style="width: 80px;height: 80px;position: absolute;margin-left: 138px;margin-top: -144px;">
                                </div>
                                <p class="sharemodule-right-a2">
                                    <span class="fenxiang-a" style="width:100%;"><?php echo $output['videoInfo'][0]['video_title']?></span>
                                    <!--  <a href="javascript:void (0)"><span class="fenxiang"></span></a>
                                      <a href="javascript:void (0)"><span class="fenxiang2"></span></a>-->
                                </p>
                            </a>
                        </script>
                        <!--  <a  class="denxiang-weixing gong">

                          </a>
                          <a  class="denxiang-weibo gong">

                          </a>
                          <a class="denxiang-qq gong">

                          </a>-->
                    </li>
                    <li class="sharemodule-right-li2">
                        <div class="sharemodule-right-b" style="font-size:15px;">
                            随机推荐
                        </div>
                        <div class="sharemodule-right-c" style="font-size:14px;">
                            <?php foreach($article as $k=>$v){?>
                                <a target="_blank" href="<?php echo urlMember('article','show',array('article_id'=>$v['article_id'])); ?>"><p>· <?php echo $v['article_title']?></p></a>
                            <?php }?>
                        </div>
                    </li>
                </ul>
            ...
            <div class="sharemodule-right-d">
                <ul class="sharemodule-vison">
                    ...
                    <?php foreach($output['videoInfo'] as $k=>$v){?>
                        <?php if($k>0){?>
                        <li>
                            <a href="javascript:void(0);">

                                <div class="sharemodule-right-d1" data-src="<?php echo $v['video_url']?>">
                                    <img class="img" src="/data/upload/shop<?php echo $v['video_img']?>">
                                    <img src="<?php echo MEMBER_TEMPLATES_URL ?>/images/video-sarch.png" style="width: 60px;height: 60px;position: absolute;margin-left: 83px;margin-top: -100px;">
                                </div>
...
<script>
    ...
    $.getJSON('/ngyp/index.php?controller=index&action=indexajax&type=2',{},function (data) {
        ...
        $(".sharemodule-right-d1").click(function () {
            $(this).parent().parent().parent().parent().parent().parent().siblings(".bg").show();
            $("source").attr("src",$(this).attr("data-src"));
            $(".vjs-tech").attr("poster",$(this).find(".img").attr("src"));
            $("video").attr("src",$(this).attr("data-src"));
            $(".sharemodule-video-guan-a").html($(this).siblings(".sharemodule-right-d ul>li p").text());
        });
