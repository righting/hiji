    ...
    <div class="user-account">
        ...
        <dl class="account03">
            <a href="<?php echo urlMember('member_voucher'); ?>" title="查看我的代金券">
                ...
                <dd class="icon"></dd>
                <dd class="value">
                    <em><?php echo $output['member_info']['voucher_count'] ? $output['member_info']['voucher_count'] : 0; ?></em>张
                </dd>
            </a>
        </dl>
        <dl class="account04">
            <a href="<?php echo urlMember('member_redpacket'); ?>">
                ...
                <dd class="icon"></dd>
                <dd class="value">
                    <em><?php echo $output['member_info']['redpacket_count'] ? $output['member_info']['redpacket_count'] : 0; ?></em>个
                </dd>
            </a>
        </dl>
        <dl class="account05">
            ...
            <?php } else { ?>
                <tr>
                    <td colspan="20" class="norecord">
                        <div class="warning-option"><span>最近您没有任何消费记录</span></div>
                    </td>
                </tr>
            <?php } ?>
            </tbody>
