...
$(function(){
	...
	$("[nc_type='unbindbtn']").bind('click',function(){
	    ...
	    ajax_get_confirm(confirm_tip,'<?php echo MEMBER_SITE_URL;?>/index.php?controller=member_sharemanage&action=unbind&type='+data_str.apikey);
	});
