    ...
    <form method="post" id="auth_form" action="index.php?controller=member_security&action=auth">
      ...
      <dl>
        ...
        <dd>
         ...
         <img src="index.php?controller=seccode&action=makecode&nchash=<?php echo getNchash();?>" name="codeimage" border="0" id="codeimage" class="ml5 vm"><a href="javascript:void(0)" class="ml5 blue" onclick="javascript:document.getElementById('codeimage').src='index.php?controller=seccode&action=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();">看不清？换张图</a>
