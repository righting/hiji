...
<link rel="stylesheet" href="/member/templates/default/css/consumption_provide.css" type="text/css" />
<script>
...
<?php
    ...
    $banner_lsit = $banner_model->where(array('c_id'=>9))->select();
...
<div class="main">
    <div class="provide">
        <div class="provide-left">
            <p class="provide-left-a">
                <span> 消费养老保险卡 </span>
            </p>
            <p class="provide-left-b">
                <span> 加盟服务中心 </span>
            </p>
            <p class="provide-left-c">
                <span> 申请消费养老保险 </span>
            </p>
        </div>
