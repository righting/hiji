  ...
  <form id="login_form" action="<?php echo urlLogin('login');?>" method="post" class="bg" >
    ...
    <dl>
      ...
      <dd>
        ...
        <img class="fl ml10" src="index.php?controller=seccode&action=makecode&nchash=<?php echo getNchash();?>" title="<?php echo $lang['login_index_change_checkcode'];?>" name="codeimage" border="0" id="codeimage" onclick="this.src='index.php?controller=seccode&action=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random()"><span></span></dd>
    </dl>
    <?php } ?>
    <ul>
    ...
    <div class="enter">
      <input type="submit" class="submit_login" value="登&#12288;录" name="Submit">
      ...
      <a href="<?php echo MEMBER_SITE_URL;?>/api.php?controller=tosina" title="<?php echo $lang['nc_otherlogintip_sina']; ?>" class="sina"><i></i>Weibo</a>
      <?php } ?>
      </span>
      <?php } ?>
    </div>
