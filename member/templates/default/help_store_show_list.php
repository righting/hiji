...
.paging-a span:nth-child(2) {
   background-color:#912edd;
   color:#fff;
}

.service-a span:last-child {
    color:#9737df;
}
    ...
    <div class="banner01">
        <!--<img src="./fixation/images/business_01.jpg">-->
        <?php foreach($output['banner_c'] as $k=>$v){?>
            ...
            <div class="business-service">
                <div class="service-detail">
                    <div class="service-search">
                        <form action="index.php?controller=help_store&action=show_list">
                    ...
                    <div class="service-answer">
                        <!--<p class="service-a">
                            <span>全部</span>&gt;<span>服务分类</span>&gt;<span><?php /*echo $output['ac_name'];*/?></span>
                        </p>-->
                        <p class="service-a">
                        ...
                        <?php if(is_array($output['article_list']) && !empty($output['article_list'])){?>
                            <?php foreach ($output['article_list'] as $ak=>$av){?>
                                ...
                                <li>
                                    <a href="<?php echo urlMember('help_store', 'show', array('article_id'=>$av['article_id']));?>">
                        ...
                        <div class="paging">
                           ...
                           <span style="float:right">未页</span>
                           <div class="paging-a">
                              <span>上一页</span>
                              <span>1</span>
                              <span>下一页</span>
