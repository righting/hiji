...
.aside-nav h5 {
    ...
    line-height: 42px;
    padding-left: 68px;
    background: url(./fixation/images/aside_nav_0001.png) 0 0 no-repeat;
}
...
.aside-nav li {
    ...
    font-size: 15px;
    letter-spacing: 1px;
    background: url(./fixation/images/aside_nav_02.png) 0 0 no-repeat;
...
.subside-in .h3-title {
    ...
    letter-spacing: 1px;
    color: #fff;
    background: url(./fixation/images/right_nav.png) no-repeat;
}
...
.subside-in .h3-title em {
    ...
    vertical-align: middle;
    background: url(./fixation/images/sort_01.png) no-repeat;
}
            ...
            <div class="aside-nav">
                ...
                <ul>
                  <?php foreach ($output['article_common'] as $sk=>$sv){?>
                    <li><a href="<?php echo urlMember('help_store', 'show', array('article_id'=>$sv['article_id']));?>"><?php echo $sv['article_title'];?></a></li>
                  <?php }?>
                </ul>
                <div class="aside-banner">
                    <a href=""><img src="./fixation/images/business_02.jpg"></a>
                </div>
            </div>
            <div class="right-nav">
