...
<div class="ncd-login-form">
  <form id="delivery_login" method="post" action="<?php echo DELIVERY_SITE_URL;?>/index.php?controller=login">
  ...
  <a href="index.php?controller=joinin" class="register">加盟物流自提服务站</a> </div>
